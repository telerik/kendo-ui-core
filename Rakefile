...
bundle :name => 'complete.commercial',
       ...
       :demos => { %w(web dataviz mobile) => 'examples' },
...
bundle :name => 'aspnetmvc.trial',
       ...
       :demos => { %w(web dataviz mobile) => 'wrappers/aspnetmvc/Examples/Kendo.Mvc.Examples/html' },
       :contents => {
