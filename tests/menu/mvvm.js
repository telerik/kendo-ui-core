...
module('menu MVVM');
    ...
    test("initializes a options from data attributes", function() {
        var dom = $('<ul data-role="menu" data-animation="false"></ul>');
    ...
    test("binding containing binding attributes", function() {
        var dom = $('<ul data-role="menu"><span data-bind="text:text"></span></ul>');
    ...
    test("event is raised if attached as option", 1, function() {
        ...
        var dom = $('<ul data-role="menu" data-select="menuMVVMSelect"></ul>');
    ...
    test("binding visible to true shows the menu", function() {
        var dom = $('<div data-role="menu" data-bind="visible: visible"></div>');
    ...
    test("binding invisible to true hides the menu", function() {
        var dom = $('<div data-role="menu" data-bind="invisible: invisible"></div>');
