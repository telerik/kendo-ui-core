(function() {
    ...
    asyncTest("uses the item template to render items", 2, function() {
        var virtualList = new VirtualList(container, {
            dataSource: asyncDataSource,
    ...
    asyncTest("accepts function as item template", 2, function() {
    ...
    //    container.scrollTop(CONTAINER_HEIGHT - 20); //scroll one item before last screen
