...
describe("Query", function() {
    ...
    it("skip and take returns a page of records", function() {
        let q = new Query([1, 2, 3]);

        let result = q.skip(1).take(2).toArray();
    ...
    it("range returns given number of items from specific index", function() {
        let q = new Query([1, 2, 3, 4, 5, 6, 7, 8]);

        let result = q.range(1, 4).toArray();
    ...
    it("orderBy sorts numbers in ascending order", function() {
        ...
        let result = new Query(data).orderBy(function(item) {
            return item;
        }).toArray();
    ...
    it("ascending sort for grouping ignores string case", function() {
        let data = [{ text: "A" }, { text: "z" }, { text: "Z" }, { text: "a" }];

        let result = new Query(data)._sortForGrouping("text", "asc");
    ...
    it("descending sort for grouping ignores string case", function() {
        ...
        let result = new Query(data)._sortForGrouping("text", "desc");
    ...
    it("orderBy sorts dates in ascending order", function() {
        let data = [new Date(2011, 1, 1), new Date(2008, 1, 1), new Date(2009, 1, 1)];
    ...
    it("orderBy sorts dates earlier then 1970 and nulls", function() {
        let data = [new Date(1955, 1, 1), null, new Date(2009, 1, 1)];
    ...
    it("orderByDescending sorts dates earlier then 1970 and multiple nulls", function() {
        let data = [new Date(1955, 1, 1), null, null, new Date(2009, 1, 1), null];

        let result = new Query(data).orderByDescending(function(item) {
            return item;
        }).toArray();
    ...
    it("orderByDescending sorts booleans and nulls", function() {
        let data = [true, false, null, false];
    ...
    it("orderBy uses selector when sorting", function() {
        let data = [{ name: "foo" }, { name: "bar" }, { name: "foo" }];
    ...
    it("orderby without parameters sorts array", function() {
        let data = new Query([3, 2, 1]).orderBy().toArray();
    ...
    it("sort using ascending descriptor", function() {
        ...
        let result = new Query(data).sort({ field: "name", dir: "asc" }).toArray();
    ...
    it("sorting nested objects", function() {
        let data = [{ foo: { age: 1 } }, { foo: { age: 2 } }];

        let result = new Query(data).sort({ field: "foo.age", dir: "desc" }).toArray();
    ...
    it("sort using descending descriptor", function() {
        ...
        let result = new Query(data).sort({ field: "name", dir: "desc" }).toArray();
    ...
    it("orderBy using custom comparer", function() {
        ...
        let result = new Query(data).orderBy({
    ...
    it("ascending sort using custom comparer", function() {
        ...
        let result = new Query(data).sort({
            dir: "asc",
            compare: function(a, b) {
                return a.name > b.name ? 1 : (a.name < b.name ? -1 : 0);
            }
    ...
    it("sort using multiple descriptors", function() {
        let data = [{ name: "foo", age: 42 }, { name: "bar", age: 36 }, { name: "foo", age: 15 }];

        let result = new Query(data).sort([{ field: "name", dir: "desc" }, { field: "age", dir: "asc" }]).toArray();
    ...
    it("sort using two strings as arguments", function() {
        ...
        let result = new Query(data).sort("name", "asc").toArray();
    ...
    it("filter isempty on string", function() {
        let data = [{ name: "" }, { name: "bar" }, { name: "foo" }];

        let result = new Query(data).filter({ field: "name", operator: "isempty" }).toArray();
    ...
    it("filter isnotempty on string", function() {
        ...
        let result = new Query(data).filter({ field: "name", operator: "isnotempty" }).toArray();

        assert.equal(result.length, 2);
    });

    it("filter isnotnull on null string", function() {
        let data = [{ name: null }, { name: "bar" }, { name: "foo" }];

        let result = new Query(data).filter({ field: "name", operator: "isnotnull" }).toArray();

        assert.equal(result.length, 2);
    });

    it("filter isnotnull on undefined string", function() {
        let data = [{ name: undefined }, { name: "bar" }, { name: "foo" }];
    ...
    it("filter isnotnull on 0", function() {
        let data = [{ name: 0 }, { name: "bar" }, { name: "foo" }];
    ...
    it("filter isnull on 0", function() {
        ...
        let result = new Query(data).filter({ field: "name", operator: "isnull" }).toArray();
    ...
    it("filter on null string", function() {
        ...
        let result = new Query(data).filter({ field: "name", operator: "eq", value: "foo" }).toArray();
    ...
    it("filter on null string with startwith", function() {
        let data = [{ name: null }, { name: "bar" }, { name: "foo" }];
        let result = new Query(data).filter({ field: "name", operator: "startswith", value: "foo", ignoreCase: true }).toArray();
    ...
    it("filter on null string with endswith", function() {
        let data = [{ name: null }, { name: "bar" }, { name: "foo" }];
        let result = new Query(data).filter({ field: "name", operator: "endswith", value: "foo", ignoreCase: true }).toArray();
    ...
    it("filter with empty expression", function() {
        ...
        let result = new Query(data).filter(null).toArray();
    ...
    it("filter contains with apostrophe", function() {
        ...
        let result = new Query(data).filter({ field: "name", value: "'", operator: "contains" }).toArray();
    ...
    it("filter with apostrophe", function() {
        ...
        let result = new Query(data).filter({ field: "name", value: "f'oo" }).toArray();

        assert.equal(result.length, 1);
    });

    it("filter with language special characters and accentFoldingFiltering enabled", function() {
        let data = [{ name: "KIZILTOPRAK" }];
        let result = new Query(data).filter({ filters: [{ field: "name", operator: "contains", value: "k\u0131z" }], accentFoldingFiltering: "tr-TR", logic: "and" }).toArray();
        assert.equal(result.length, 1);
    });
    ...
    it("filter with standart characters and accentFoldingFiltering enabled should not match language special characters", function() {
        let data = [{ name: "KIZILTOPRAK" }];
        let result = new Query(data).filter({ filters: [{ field: "name", operator: "contains", value: "kiz" }], accentFoldingFiltering: "tr-TR", logic: "and" }).toArray();
        assert.equal(result.length, 0);
    });

    it("filter with language special characters and accentFoldingFiltering disabled", function() {
        let data = [{ name: "KIZILTOPRAK" }];
        let result = new Query(data).filter({ filters: [{ field: "name", operator: "contains", value: "k\u0131z" }], logic: "and" }).toArray();
        assert.equal(result.length, 0);
    });
    ...
    it("filter with language special characters, with equal operator", function() {
        ...
        let result = new Query(data).filter({ filters: [{ field: "name", operator: "eq", value: "k\u0131z\u0131ltoprak" }], logic: "and", accentFoldingFiltering: "tr-TR" }).toArray();
        assert.equal(result.length, 1);
    });
    ...
    it("filter with language special characters, with not equal operator", function() {
        ...
        let result = new Query(data).filter({ filters: [{ field: "name", operator: "neq", value: "k\u0131z\u0131ltoprak" }], logic: "and", accentFoldingFiltering: "tr-TR" }).toArray();
        assert.equal(result.length, 2);
    });
    ...
    it("filter with empty filters", function() {
        ...
        let result = new Query(data).filter({ filters: [] }).toArray();

        assert.equal(result.length, 3);
    });

    it("filter filters on numbers", function() {
        let data = [{ field: 100 }, { field: 10 }, { field: 1 }];

        let result = new Query(data).filter({
            field: "field",
            operator: "eq",
            value: 1
        }).toArray();
    ...
    it("filter filters with field as a function", function() {
        let data = [100, 10, 1];
        let fieldFunctionWasCalled = false;
    ...
    it("filter filters on nullable dates", function() {
        let data = [new Date(2011, 1, 1), null, new Date(2009, 1, 1)];
    ...
    it("filter with date filters out strings and numbers", function() {
        let data = [new Date(2011, 1, 1), "foo", 42];
    ...
    it("filter filters with eq on string", function() {
        let data = [{ field: "a" }, { field: "b" }, { field: "c" }];
    ...
    it("filter filters with startswith on string", function() {
        let data = [{ field: "abc" }, { field: "bcd" }, { field: "cde" }];
    ...
    it("filter filters with eq on string case sensitive", function() {
        let data = [{ field: "a" }, { field: "b" }, { field: "c" }, { field: "A" }];
    ...
    it("filter on dotnet date literals", function() {
        let firstDate = new Date(1996, 11, 9);
        let data = [{ bar: firstDate }, { bar: new Date(1996, 11, 12) }];
    ...
    it("filter on nested nullable objects", function() {
        let data = [{ foo: { bar: 1 } }, { foo: { bar: undefined } }];
    ...
    it("groupby groups data by field", function() {
        let data = [{ field: 100 }, { field: 100 }, { field: 1 }];

        let result = new Query(data).groupBy({
            field: "field"
        }).toArray();
        assert.equal(result.length, 2);
    ...
    it("groupby should be stable", function() {
        let data = [{ foo: 1, bar: 1 }, { foo: 2, bar: 1 }, { foo: 3, bar: 1 }, { foo: 4, bar: 1 }, { foo: 5, bar: 1 },
        { foo: 6, bar: 1 }, { foo: 7, bar: 1 }, { foo: 8, bar: 1 }, { foo: 9, bar: 1 }, { foo: 0, bar: 1 }, { foo: 11, bar: 1 }];

        let result = new Query(data)
    ...
    it("groupby on dates should be stable", function() {
        let data = [{ foo: 1, bar: new Date(1999, 1, 1) }, { foo: 2, bar: new Date(1999, 1, 1) }, { foo: 3, bar: new Date(1999, 1, 1) }, { foo: 4, bar: new Date(1999, 1, 1) }, { foo: 5, bar: new Date(1999, 1, 1) }, { foo: 6, bar: new Date(1999, 1, 1) }, { foo: 7, bar: new Date(1999, 1, 1) }, { foo: 8, bar: new Date(1999, 1, 1) }, { foo: 9, bar: new Date(1999, 1, 1) }, { foo: 0, bar: new Date(1999, 1, 1) }, { foo: 11, bar: new Date(1999, 1, 1) }];
    ...
    it("groupby on dates with descending sort should be stable", function() {
        let data = [{ foo: 11, bar: new Date(1999, 1, 1) }, { foo: 10, bar: new Date(1999, 1, 1) }, { foo: 9, bar: new Date(1999, 1, 1) }, { foo: 8, bar: new Date(1999, 1, 1) }, { foo: 7, bar: new Date(1999, 1, 1) }, { foo: 6, bar: new Date(1999, 1, 1) }, { foo: 5, bar: new Date(1999, 1, 1) }, { foo: 4, bar: new Date(1999, 1, 1) }, { foo: 3, bar: new Date(1999, 1, 1) }, { foo: 2, bar: new Date(1999, 1, 1) }, { foo: 1, bar: new Date(1999, 1, 1) }];
    ...
    it("groupby groups data by date", function() {
        let data = [{ field: new Date(2011, 1, 1) }, { field: new Date(2011, 2, 2) }, { field: new Date(2011, 1, 1) }];
    ...
    it("groupby returns ungroup collection if no descriptors are provided", function() {
        ...
        let result = new Query(data).group().toArray();
    ...
    it("groupby groups data by field and direction", function() {
        ...
        let result = new Query(data).group([{
            field: "field",
            dir: "desc"
        }]).toArray();
        assert.equal(result.length, 2);
    ...
    it("groupby groups data by multiple fields", function() {
        let data = [{ foo: 100, bar: "baz" }, { foo: 100, bar: "bar" }, { foo: 1, bar: "baz" }],
            firstGroup,
            secondGroup;

        let result = new Query(data).group([{ field: "foo" }, { field: "bar" }]).toArray();
    ...
    it("group by nullable string with more than 10 items", function() {
        ...
        let result = new Query(data).group({ field: "bar" }).toArray();
    ...
    it("group by nullable string with more than 10 items descending", function() {
        ...
        let result = new Query(data).group({ field: "bar", dir: "desc" }).toArray();
    ...
    it("groupby groups data by multiple fields with 3 levels", function() {
        let data = [{ foo: 100, bar: "baz", baz: "baz" }, { foo: 100, bar: "bar", baz: "baz" }, { foo: 1, bar: "baz", baz: "baz" }],
            firstGroup,
            secondGroup;

        let result = new Query(data).group([{ field: "foo" }, { field: "bar" }, { field: "baz" }]).toArray();
        assert.equal(result.length, 2);
        firstGroup = result[0];
        secondGroup = result[1];
    ...
    it("group by nullable boolean", function() {
        ...
        let result = new Query(data).sort({ field: "foo", dir: "desc" }).group({ field: "bar" }).toArray();
    ...
    it("sort asc when group by nullable boolean", function() {
        ...
        let result = new Query(data).sort({ field: "foo", dir: "asc" }).group({ field: "bar" }).toArray();
    ...
    it("sort asc by nullable string with more than 10 items", function() {
        ...
        let result = new Query(data).sort({ field: "bar", dir: "asc" }).toArray();
    ...
    it("sort desc by nullable string with more than 10 items", function() {
        ...
        let result = new Query(data).sort({ field: "bar", dir: "desc" }).toArray();
    ...
    it("group aggregates are calculated if provided", function() {
        ...
        let result = new Query(data).group([{ field: "foo", aggregates: [{ field: "foo", aggregate: "sum" }] }]).toArray();
    ...
    it("group aggregates are caseinsensitive", function() {
        ...
        let result = new Query(data).group([{ field: "bar", aggregates: [{ field: "foo", aggregate: "sum" }] }]).toArray();
    ...
    it("group aggregates are calculated  for multiple fields if provided", function() {
        ...
        let result = new Query(data).group([{ field: "foo", aggregates: [{ field: "foo", aggregate: "sum" }, { field: "bar", aggregate: "count" }] }]).toArray();
    ...
    it("group aggregates with multiple group levels and paging original data is required", function() {
        ...
        let result = new Query(data).skip(1).take(1).group([
            { field: "foo", aggregates: [{ field: "foo", aggregate: "sum" }] },
            { field: "bar", aggregates: [{ field: "foo", aggregate: "sum" }] }
        ], data).toArray();
    ...
    it("aggregate calculates aggregates for a collection", function() {
        ...
        let result = new Query(data).aggregate([{ field: "foo", aggregate: "sum" }, { field: "bar", aggregate: "count" }]);
    ...
    it("aggregate returns empty object if no descriptor are provided", function() {
        ...
        let result = new Query(data).aggregate();
    ...
    it("aggregate max returns max value for a given field", function() {
        ...
        let result = new Query(data).aggregate([{ field: "foo", aggregate: "max" }]);

        assert.equal(result.foo.max, 100);
    });

    it("aggregate average return null if data is null", function() {
        let data = [{ foo: null, bar: "baz" }, { foo: null, bar: "bar" }, { foo: null, bar: "baz" }];

        let result = new Query(data).aggregate([{ field: "foo", aggregate: "average" }]);

        assert.equal(result.foo.average, null);
    });

    it("aggregate average skips null values", function() {
        let data = [{ foo: null, bar: "baz" }, { foo: 10, bar: "bar" }];
    ...
    it("aggregate average skips null values but calculates zeros", function() {
        let data = [{ foo: null, bar: "baz" }, { foo: 10, bar: "bar" }, { foo: 0, bar: "bar" }];
    ...
    it("aggregate function should be caseinsensitive", function() {
        ...
        let result = new Query(data).aggregate([{ field: "foo", aggregate: "Min" }]);
    ...
    it("aggregate min returns min value for a given field with nulls", function() {
        let data = [{ foo: 1, bar: "baz" }, { foo: 100, bar: "baz" }, { foo: null, bar: "baz" }, { foo: 100, bar: "bar" }];
    ...
    it("aggregate min returns min value for a given field with 0", function() {
        let data = [{ foo: 1, bar: "baz" }, { foo: 100, bar: "baz" }, { foo: 0, bar: "baz" }, { foo: 100, bar: "bar" }];
    ...
    it("aggregate min returns min value for a given field with undefined", function() {
        let data = [{ foo: 1, bar: "baz" }, { foo: 100, bar: "baz" }, { foo: undefined, bar: "baz" }, { foo: 100, bar: "bar" }];
    ...
    it("aggregate max returns null if all fields are null", function() {
        let data = [{ foo: null, bar: "baz" }, { foo: null, bar: "baz" }, { foo: null, bar: "baz" }, { foo: null, bar: "bar" }];
    ...
    it("aggregate max returns null if all fields are undefined or null", function() {
        let data = [{ foo: null, bar: "baz" }, { foo: undefined, bar: "baz" }, { foo: null, bar: "baz" }, { foo: undefined, bar: "bar" }];
    ...
    it("aggregate max returns undefined if all fields are undefined", function() {
        let data = [{ foo: undefined, bar: "baz" }, { foo: undefined, bar: "baz" }];
    ...
    it("aggregate max returns min value for a given field with null", function() {
        let data = [{ foo: 10, bar: "baz" }, { foo: 100, bar: "baz" }, { foo: null, bar: "baz" }, { foo: 10, bar: "bar" }];
    ...
    it("aggregate max returns min value for a given field with undefined", function() {
        let data = [{ foo: 10, bar: "baz" }, { foo: 100, bar: "baz" }, { foo: undefined, bar: "baz" }, { foo: 10, bar: "bar" }];
    ...
    it("aggregate max returns min value for a given field with 0", function() {
        let data = [{ foo: 10, bar: "baz" }, { foo: 100, bar: "baz" }, { foo: 0, bar: "baz" }, { foo: 10, bar: "bar" }];
    ...
    it("aggregate max with date", function() {
        let data = [{ foo: new Date("2013/05/06"), bar: "baz" }, { foo: new Date("2050/05/06"), bar: "bar" }, { foo: new Date("1940/05/06"), bar: "baz" }, { foo: new Date("1980/05/06"), bar: "baz" }];
    ...
    it("aggregate min with date and null", function() {
        let data = [{ foo: new Date("2013/05/06"), bar: "baz" }, { foo: null, bar: "bar" }, { foo: new Date("1940/05/06"), bar: "baz" }, { foo: null, bar: "bar" }, { foo: new Date("1980/05/06"), bar: "baz" }];
    ...
    it("aggregate count with null", function() {
        ...
        let result = new Query(data).aggregate([{ field: "foo", aggregate: "count" }]);
    ...
    it("group group should have hasSubgroups set to false", function() {
        ...
        let result = new Query(data).group([{ field: "foo" }], data).toArray();
    ...
    it("aggregate return empty object if data is undefined", function() {
        let result = new Query(undefined).aggregate([{ field: "foo", aggregate: "sum" }, { field: "bar", aggregate: "count" }]);
    ...
    it("filter isnullorempty on string", function() {
        let data = [{ name: null }, { name: "" }, { name: " " }, { name: "bar" }, { name: "foo" }];

        let result = new Query(data).filter({ field: "name", operator: "isnullorempty" }).toArray();
    ...
    it("filter isnotnullorempty on string", function() {
        ...
        let result = new Query(data).filter({ field: "name", operator: "isnotnullorempty" }).toArray();
