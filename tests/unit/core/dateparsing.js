...
let parse = kendo.parseDate;
let date;

function isValidDate(year, month, day, date) {
    let isValid = true;

    if (year != date.getFullYear()) { isValid = false; }
    else if (month != date.getMonth() + 1) { isValid = false; }
    else if (day != date.getDate()) { isValid = false; }
...
function isValidDateTime(date, year, month, day, hours, minutes, seconds, milliseconds) {
    ...
    else if (hours && hours != date.getHours()) { isValid = false; }
    else if (minutes && minutes != date.getMinutes()) { isValid = false; }
    else if (seconds && seconds != date.getSeconds()) { isValid = false; }
    else if (milliseconds && milliseconds != date.getMilliseconds()) { isValid = false; }
...
describe("date parsing", function() {
    ...
    it("parse should use calendar.patterns if no format is provided", function() {
        let result = parse("10/12/2000 10:10:10 AM");
    ...
    it('parse gets shortYearCutOff from culture', function() { // ISO format
        ...
        let result = parse("12/23/21", "M/d/yy");
    ...
    it('parse G date format time parsing', function() { // ISO format
        ...
        let dateFormat = "G";
        let result = parse("12/23/2000 8:12:22 pm", dateFormat);
    ...
    it('parse G date time at midnight', function() { // ISO format
        ...
        let dateFormat = "G";
        let result = parse("10/23/2000 12:00:00 pm", dateFormat);
    ...
    it('parse G date time at noon', function() { // ISO format
        ...
        let dateFormat = "G";
        let result = parse("10/23/2000 12:00:00 am", dateFormat);
    ...
    it('parse ISO date format', function() { // ISO format
        ...
        let result = parse("12-23-2000", dateFormat);
        assert.isOk(isValidDate(2000, 12, 23, result));
    });
    ...
    it('parse Arabic date format', function() { // Also : Galician, Divehi
        ...
        let result = parse("10/10/99", dateFormat);
    ...
    it('parse Bulgarian Language date format', function() { //
        ...
        let result = parse("23.12.2000 '?.'", dateFormat);
        assert.isOk(isValidDate(2000, 12, 23, result));
    });
    ...
    it('parse Chinese Language date format', function() {
        ...
        let result = parse("2000/12/23", dateFormat);
        assert.isOk(isValidDate(2000, 12, 23, result));
    });
    ...
    it('parse Dutch Language date format', function() {
        ...
        let dateFormat = "d-M-yyyy";
        let result = parse("23-2-2008", dateFormat);
    ...
    it('parse Estonian Language date format', function() {
        ...
        let result = parse("23.12.2008", dateFormat);
    ...
    it('parse Latvian Language date format', function() {
        ...
        let dateFormat = "yyyy.MM.dd.";
        let result = parse("2008.12.23.", dateFormat);
        assert.isOk(isValidDate(2008, 12, 23, result));
    });
    ...
    it('parse Mongolian Language date format', function() {
        ...
        let result = parse("99.12.25", dateFormat);
    ...
    it('parse Invariant Language long date format', function() { // Also: Persian
        ...
        let result = parse("Saturday, 23 December 2000", dateFormat);
        assert.isOk(isValidDate(2000, 12, 23, result));
    });

    it('parse method skips dddd in favor of dd value', function() { // Also: Persian
        let dateFormat = "dd MMMM yyyy, dddd";
        let result = parse("23 December 2000, Saturday", dateFormat);
        assert.isOk(isValidDate(2000, 12, 23, result));
    });
    ...
    it('parse Arabic long date format', function() {
        ...
        let result = parse("10/September/2009", dateFormat);
    ...
    it('parse Catalan long date format', function() {
        ...
        let dateFormat = "dddd, d' / 'MMMM' / 'yyyy";
        let result = parse("Saturday, 23 / December / 2000", dateFormat);
        assert.isOk(isValidDate(2000, 12, 23, result));
    });
    ...
    it('parse Chinese long date format', function() {
        ...
        let dateFormat = "yyyy'?'M'?'d'?'";
        let result = parse("2009?9?10?", dateFormat);
        assert.isOk(isValidDate(2009, 9, 10, result));
    });
    ...
    it('parse Greek long date format', function() {
        ...
        let dateFormat = "dddd, d MMMM yyyy";
        let result = parse("Saturday, 3 December 2000", dateFormat);
        assert.isOk(isValidDate(2000, 12, 3, result));
    });

    it('parse English long date format', function() {

        let dateFormat = "dddd, MMMM dd, yyyy";
        let result = parse("Saturday, December 3, 2000", dateFormat);
        assert.isOk(isValidDate(2000, 12, 3, result));
    });

    it('parse Finnish long date format', function() {

        let dateFormat = "d. MMMM'ta 'yyyy";
        let result = parse("23. Decemberta 2000", dateFormat);
        assert.isOk(isValidDate(2000, 12, 23, result));
    });
    ...
    it('parse Hungarian long date format', function() {
        ...
        let dateFormat = "yyyy. MMMM d.";
        let result = parse("2000. December 23.", dateFormat);
        assert.isOk(isValidDate(2000, 12, 23, result));
    });
    ...
    it('parse Icelandic long date format', function() {
        ...
        let dateFormat = "d. MMMM yyyy";
        let result = parse("23. December 2000", dateFormat);
        assert.isOk(isValidDate(2000, 12, 23, result));
    });
    ...
    it('parse Japanese long date format', function() {
        ...
        let dateFormat = "yyyy'?'M'?'d'?'";
        let result = parse("2000?12?3?", dateFormat);
        assert.isOk(isValidDate(2000, 12, 3, result));
    });
    ...
    it('parse Brazil long date format', function() {
        ...
        let dateFormat = "dddd, d' de 'MMMM' de 'yyyy";
        let result = parse("Saturday, 3 de December de 2000", dateFormat);
        assert.isOk(isValidDate(2000, 12, 3, result));
    });
    ...
    it('parse Polish long date format', function() { //Also Romanian, Thailand, Belarusian
        ...
        let dateFormat = "d MMMM yyyy";
        let result = parse("3 December 2000", dateFormat);
        assert.isOk(isValidDate(2000, 12, 3, result));
    });
    ...
    it('parse Swedish long date format', function() {
        ...
        let dateFormat = "'den 'd MMMM yyyy";
        let result = parse("den 23 December 2000", dateFormat);
        assert.isOk(isValidDate(2000, 12, 23, result));
    });
    ...
    it('parse Estonian long date format', function() {
        ...
        let dateFormat = "d. MMMM yyyy'. a.'";
        let result = parse("3. December 2000. a.", dateFormat);
        assert.isOk(isValidDate(2000, 12, 3, result));
    });

    it('parse Latvian long date format', function() {

        let dateFormat = "dddd, yyyy'. gada 'd. MMMM";
        let result = parse("Saturday, 2000. gada 3. December", dateFormat);
        assert.isOk(isValidDate(2000, 12, 3, result));
    });

    it('parse Lithuanian long date format', function() {

        let dateFormat = "yyyy 'm.' MMMM d 'd.'";
        let result = parse("2000 m. December 23 d.", dateFormat);
        assert.isOk(isValidDate(2000, 12, 23, result));
    });

    it('parse Basque long date format', function() {

        let dateFormat = "dddd, yyyy.'eko' MMMM'k 'd";
        let result = parse("Saturday, 2000.eko Decemberk 3", dateFormat);
        assert.isOk(isValidDate(2000, 12, 3, result));
    });
    ...
    it('parse date time format', function() { // ISO format
        ...
        let result = parse("22/Aug/2006 06:30:07", dateFormat);
    ...
    it('parse invalid date should return null', function() {
        ...
        let result = parse("1//2100", dateFormat);
        assert.equal(result, null);
    });

    it('parse MMMM yyyy date format', function() {
        let dateFormat = "MMMM yyyy";
        let result = parse("January 2000", dateFormat);
    ...
    it('parse MMMM yyyy date format if the current culture contains months with names that start with the same letters', function() {
        let dateFormat = "MMMM yyyy";
        let calendar = kendo.culture().calendar;
        let monthNames = (calendar._lowerMonths || calendar.months).names;
        let originalMonthName = monthNames[5];
        try {
            monthNames[5] = monthNames[6].substr(0, monthNames[6].length - 1);
            let result = parse(monthNames[6] + " 2000", dateFormat);
    ...
    it('parse G format of ko-KR culture', function() {
        ...
        let oldAM = calendar.AM;
        let oldPM = calendar.PM;
        let oldPatterns = calendar.patterns;
        ...
        try {
            let result = parse("2016-05-27 오전 11:00");
    ...
    tzTest('Sofia', 'parses more specific standard formats before culture date formats', function() {
        let calendar = kendo.culture().calendar;
        let shortDatePattern = calendar.patterns.d;

        try {
            calendar.patterns.d = "yyyy-MM-dd";
            let result = parse("2016-02-29T15:22:46+01:00");
    ...
    it('parse should return null if only year is passed', function() {
        ...
        let result = parse("2010", dateFormat);

        assert.equal(result, null);
    });

    it("parse should be able to parse using multiple formats", function() {
        let formats = ["G", "M/dd/yyyy"];
        let result = parse("2/2/2000", formats);

        assert.notEqual(result, null);
    });

    it("parse() should parse string using predefined patters", function() {
        let result = parse("2/2/2000");
        let result1 = parse("Thu Nov 24 2011 18:06:53 GMT+0200 (FLE Standard Time)");
    ...
    it("parseExact method parses UTC iso8601", function() {
        let utcDate = new Date(Date.UTC(2000, 9, 10, 14, 30, 0));
    ...
    it("parseExact method parses UTC milliseconds correctly", function() {
        let utcDate = new Date(Date.UTC(2000, 9, 10, 14, 30, 0, 450));
    ...
    it("parseDate parses result from kendo.stringify", function() {
        let date = kendo.stringify(new Date(2000, 10, 10, 14, 15, 30, 333));
    ...
    it("parseDate parses /Date(-milliseconds)/ string", function() {
        let result = new Date(1965, 0, 1);
        let dateString = "/Date(" + result.getTime() + ")/";
    ...
    it("parseDate parses /Date(milliseconds+offset)/ string", function() {
        let date = new Date();
        let utcDate = kendo.timezone.apply(date, 0);
        let adjustedDate = kendo.timezone.convert(utcDate, 0, -150);

        let dateString = "/Date(" + date.getTime() + "+0230)/";

        assert.deepEqual(parse(dateString), adjustedDate);
    });

    it("parseDate parses /Date(milliseconds+offset)/ string (2)", function() {
        let utcTime = 1376949210000;
        let tzoffset = new Date(utcTime).getTimezoneOffset();

        let sign = tzoffset > 0 ? "-" : "+";
        tzoffset = Math.abs(tzoffset);

        let minutes = tzoffset % 60;
        let hours = (tzoffset - minutes) / 60;

        let msoffset = sign + kendo.toString(hours, "00") + kendo.toString(minutes, "00");
        let dateString = "/Date(" + utcTime + msoffset + ")/";

        assert.deepEqual(parse(dateString), new Date(utcTime));
    });

    it("parseDate does not parse ISO8601 with format dd.MM.yyyy", function() {
        let dateString = "2012-08-16T21:00:00Z";
    ...
    it("parseDate uses today's date when parse only time portion", function() {
        let today = new Date();
        let result = parse("10:00 AM", "hh:mm tt");
    ...
    it("parseDate does not trim out zeroes when there are only two characters", function() {
        let result = parse("2023/07/21 3:01 AM", "yyyy/MM/dd h:mm tt", "en-us", true);
        assert.deepEqual(result, new Date(2023, 6, 21, 3, 1, 0));
    });

    it("parseDate works correctly with cultures that include dots", function() {
        let result = parse("21.07.2023", "dd.MM.yyyy", "en-us", true);
        assert.deepEqual(result, new Date(2023, 6, 21));
    });

    it("parseExact method parses date string with UTC 'Z' zone designator", function() {
        let utcDate = new Date(Date.UTC(2014, 4, 21, 0, 0, 0));
        let result = kendo.parseDate("2014-05-21 00:00:00Z", "yyyy-MM-dd HH:mm:sszz");

        assert.deepEqual(result, utcDate);
    });

    it('time portion is copied to new date', function() {
        let time = new Date(2016, 0, 1, 12, 15, 0);
        let date = new Date(2016, 0, 15, 14, 0, 0);
        let result = kendo.date.setHours(date, time);
    ...
    it('negative sign for minutes is taken into account when parsing', function() {
        let date = new Date(2017, 1, 23, 10, 0, 0);
    ...
    it('setHours should work correctly when daylight saving time change occurs', function() {
        let initialDate = new Date(2019, 2, 30, 23, 59, 0);
        let newDate = new Date(2019, 2, 31, 0, 0, 0);
        let expectedDate = new Date(2019, 2, 31, 23, 59, 0);
