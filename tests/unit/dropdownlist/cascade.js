...
describe("kendo.ui.DropDownLists Cascading DropDownLists", function() {
    ...
    it("Clear child ddl if no data after filtration", function() {
        ...
        let parentCB = parent.data("kendoDropDownList");
        let childCB = child.data("kendoDropDownList");
    ...
    asyncTest("Cascading DDLs with initial values", function(done) {
    ...
    asyncTest("Cascading DDLs handles consecutive calls of value method", function(done) {
        let ddl = new DropDownList(parent, {
            optionLabel: "Select",
            dataValueField: "id",
            dataTextField: "id",
    ...
    asyncTest("DropDownList does not clear value if parent has value", function(done) {
        let ddl = new DropDownList(parent, {
            optionLabel: "Select",
            dataValueField: "id",
            dataTextField: "id",
        ...
        let ddl2 = new DropDownList(child.attr("id", "child"), {
            optionLabel: "Select",
            dataValueField: "text",
            dataTextField: "text",
            dataSource: datasource,
        ...
        let ddl3 = new DropDownList($("<input />"), {
            optionLabel: "Select",
            dataValueField: "text",
            dataTextField: "text",
            dataSource: datasource,
    ...
    it("DropDownList clears value if parent has no value", function() {
        ...
        let ddl3 = new DropDownList(third, {
            optionLabel: "Select",
            dataValueField: "text",
            dataTextField: "text",
            dataSource: [
    ...
    it("third combo is bound when only local data is used", function() {
        let categories = new DropDownList(parent, {
        ...
        let products = new DropDownList(child, {
            cascadeFrom: "parent",
        ...
        let orders = new DropDownList(third, {
            cascadeFrom: "child",
    ...
    asyncTest("do not raise cascade if filtered with no items", function(done) {
        let count = 0;
        let categories = new DropDownList(parent, {
            delay: 0,
            filter: "startswith",
    ...
    asyncTest("child widget selects its value after parents starts cascading", function(done) {
    ...
    it("active widget does not filter child if popup is opened", function() {
        ...
        let childSource = ddl2.dataSource.view();
    ...
    asyncTest("select the value of 3rd widget when it is bound and still not cascaded", function(done) {
        ...
        ddl3.one("dataBound", function() {
            ...
            ddl3.one("dataBound", function() {
                done(() => assert.equal(ddl3.value(), "item2"));
            });
        });
    ...
    asyncTest("child widget strips filter expression on subsequent parent selection", function(done) {
        let ddl = new DropDownList(parent, {
            optionLabel: "Select",
            dataValueField: "id",
            dataTextField: "text2",
        ...
        ddl2.one("dataBound", function() {
            ...
            ddl2.one("dataBound", function() {
                ...
                let filters = ddl2.dataSource.filter().filters;

                done(() => assert.equal(filters.length, 1));
            });
        });
    });

    asyncTest("children cascades when parent is focused", function(done) {
        let ddl = new DropDownList(parent, {
            optionLabel: "Select",
            dataValueField: "id",
            dataTextField: "text2",
        ...
        ddl2.one("dataBound", function() {
            done(() => assert.equal(ddl2.value(), "item4"));
        });
    });
