...
describe("SplitButton aria attributes", function() {
    ...
    it("SplitButton renders default aria attributes", function() {
        ...
        assert.equal(splitButton.arrowButton.attr("aria-expanded"), "false");
        assert.equal(splitButton.arrowButton.attr("aria-controls"), splitButton.menu.list.attr("id"));
    });

    it("SplitButton renders correct aria-label attr", function() {
        button.attr("aria-label", "new label");
        new SplitButton(button, { items: defaultItems });
    ...
    it("SplitButton renders correct aria-controls", function() {
        ...
        assert.equal(splitButton.arrowButton.attr("aria-controls"), "buttonElm_buttonmenu");
    });
