(function() {
    test("initializes a tabstrip when data role is tabstrip", function() {
        var dom = $('<div data-role="tabstrip"></div>');
    ...
    test("initializes a options from data attributes", function() {
        var dom = $('<div data-role="tabstrip" data-animation="false"></div>');
    ...
    test("binding tabstrip initialized before binding", function() {
        var dom = $('<div data-animation="false"></div>');
    ...
    test("binding containing binding attributes", function() {
        var dom = $('<div data-role="tabstrip"><span data-bind="text:text"></span></div>');
    ...
    test("animation is extended if widget is initialized before the binding", function() {
        var dom = $('<div data-role="tabstrip" data-animation=\"{"open":{"effects":"fadeIn"}}\"/>');
    ...
    test("event is raised if attached as option", 1, function() {
        ...
        var dom = $('<div data-role="tabstrip" data-select="tabstripMVVMSelect"></div>');
    ...
    test("tabstrip is bound to data source", function() {
        var dom = $('<div data-role="tabstrip" data-bind="source: tabs"></div>');
        var viewModel = {
            tabs: ["foo", "bar"]
        };
    ...
    test("data text field is used when data binding", function() {
        var dom = $('<div data-role="tabstrip" data-text-field="foo" data-bind="source: tabs"></div>');
    ...
    test("setting the value of the tabstrip", function() {
        var dom = $('<div data-role="tabstrip" data-bind="value: tab, source: tabs"></div>');
    ...
    test("setting the value of the tabstrip when bound to complex object", function() {
        var dom = $('<div data-role="tabstrip" data-text-field="name" data-bind="value: tab, source: tabs"></div>');
    ...
    test("updating an item from the array updates the corresponding tab", function() {
        var dom = $('<div data-role="tabstrip" data-text-field="name" data-bind="source: tabs"></div>');
    ...
    test("assign to DataSource as ViewModel field", function() {
        var dom = $('<div data-role="tabstrip" data-bind="source:dataSource" />');
    ...
    test("binding visible to true shows the tabstrip", function() {
        var dom = $('<div data-role="tabstrip" data-bind="visible: visible"></div>');
    ...
    test("binding invisible to true hides the tabstrip", function() {
        var dom = $('<div data-role="tabstrip" data-bind="invisible: invisible"></div>');
