(function() {
    ...
    test("tab role is set to items when created from html", function() {
        div = $('<div id="test"><ul><li>foo</li><li>bar</li></ul></div>')
    ...
    test("TabStrip preserves the id of the LI elements", function() {
        var tabstrip = $("<ul id='test'><li id='custom' class='k-state-active'>Test</li><li>Test2</li></ul>").kendoTabStrip().data("kendoTabStrip");
    ...
    test("TabStrip uses id of the LI element for the aria-activedescendant", function() {
        var tabstrip = $("<ul id='test'><li id='custom' class='k-state-active'>Test</li><li>Test2</li></ul>").kendoTabStrip().data("kendoTabStrip");
