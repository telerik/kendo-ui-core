(function() {
    ...
    test("clicking on the document clears task selection", function() {
        gantt.select("tr[data-uid]:first");
    ...
    test("clicking on the document clears dependency selection", function() {
        gantt.timeline.selectDependency("div.k-line:first");

        $(document).click();

        equal(gantt.timeline.selectDependency().length, 0);
    });
