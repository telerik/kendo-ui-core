import { createInput, updateInputAt, createMasked, deleteBackwards, deleteContent, updateInput } from "../../helpers/maskedtextbox-utils.js";
import { stub } from "../../helpers/stub.js";

let MaskedTextBox = kendo.ui.MaskedTextBox;
let input;
let caret = kendo.caret;
let createMaskedTextBox;
...
describe("kendo.ui.MaskedTextBox navigation:", function() {
    ...
    it("replace empty symbol if valid", function() {
        let masked = createMasked(input, "0-0");
        masked.value("_-_");
    ...
    it("does not modify value on invalid symbol", function() {
        let masked = createMasked(input, "0000");
        masked.value("0___");
    ...
    it("multiple chars delete with BACKSPACE", function() {
        let masked = createMasked(input, "0-00");
        masked.value("2-34");
    ...
    it("delete 0s from the end of the input with BACKSPACE", function() {
        let masked = createMasked(input, "0-0000");
        masked.value("1-2000");
    ...
    it("BACKSPACE over static char ending at mask specific numeric chars", function() {
        let masked = createMasked(input, "00-00-00");
        masked.value("00-00");
    ...
    it("BACKSPACE over static char ending at mask specific letter chars", function() {
        let masked = createMasked(input, "LL-LL-00");
        masked.value("LL-LL");
    ...
    it("delete prompt char before ambiguous static char", function() {
        let masked = createMasked(input, "0-0\\00");
        masked.value("1-_0_");
    ...
    it("removes whole value", function() {
        let masked = createMasked(input, "(000) 0000-000");
    ...
    it("unmasks before inserting pasted value", function() {
        let masked = createMasked(input, "00--00");
        masked.value("12--34");
    ...
    it("delete existing content keeps the mask", function() {
        let masked = createMasked(input, "(000) 000");
    ...
    it("allows space in middle of mask", function() {
        let masked = createMasked(input, "(000) 999");
    ...
    it("add duplicated content", function() {
        let masked = createMasked(input, "00-0000");
    ...
    it("insert multiple over a static char", function() {
        let masked = createMasked(input, "0-00\\00");
        masked.value("1-__0_");
