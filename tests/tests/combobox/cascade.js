...
function destroy(input) {
    ...
    let cb = input.data("kendoComboBox");
...
describe("kendo.ui.ComboBox Cascading ComboBoxes", function() {
    ...
    it("Set autoBind option to false", function() {
        ...
        let childCB = child.data("kendoComboBox");
    ...
    it("Parent filter child on change", function() {
        ...
        let parentCB = parent.data("kendoComboBox"),
    ...
    it("Parent with empty value deactivates child", function() {
        ...
        assert.include(["disabled", "true"], childCB.element.attr("disabled"));
    });
    ...
    it("Child on third level is disabled", function() {
        ...
        let thirdCB = third.kendoComboBox({
        ...
        assert.include(["disabled", "true"], thirdCB.element.attr("disabled"));
    });
    ...
    asyncTest("filtering child combo does not re-input the selected value", function(done) {
        parent.kendoComboBox({
            dataTextField: "parentID",
            dataValueField: "parentID",
            dataSource: [
        ...
        childCB.bind("dataBound", function() {
            done(() => assert.equal(childCB.input.val(), ""));
        });
    ...
    it("third combo is bound when only local data is used", function() {
        let categories = new ComboBox(parent, {
            filter: "contains",
        ...
        let products = new ComboBox(child, {
            cascadeFrom: "parent",
            filter: "contains",
    ...
    asyncTest("child widget selects its value after parents starts cascade", function(done) {
        let deferred = $.Deferred();

        let combo1 = new ComboBox(parent, {
            dataTextField: "CategoryName",
            dataValueField: "CategoryID",
            dataSource: [
    ...
    it("widget clears child value on cascade", function() {
        parent.kendoComboBox({
            dataTextField: "parentID",
            dataValueField: "parentID",
            dataSource: [
    ...
    it("widget does not filter child if popup is opened", function() {
        let parentCB = new ComboBox(parent, {
            animation: false,
            dataValueField: "id",
            dataTextField: "text2",
            dataSource: [
        ...
        let parentCB2 = new ComboBox(child, {
            dataValueField: "text",
            dataTextField: "text",
            cascadeFrom: "parent",
            dataSource: {
        ...
        let childSource = parentCB2.dataSource.view();
    ...
    it("widget filters child on popup close", function() {
        ...
        let parentCB2 = new ComboBox(child.attr("id", "child"), {
            dataValueField: "text",
            dataTextField: "text",
            cascadeFrom: "parent",
            dataSource: {
    ...
    it("child widget triggers change if selected value is cleared", function() {
        ...
        let combo2 = new ComboBox(child.attr("id", "child"), {
            optionLabel: "Select",
            dataValueField: "text",
            dataTextField: "text",
            cascadeFrom: "parent",
    ...
    asyncTest("keep custom value of the widget it is custom", function(done) {
        let deferred = $.Deferred();
        let combo = new ComboBox(parent, {
    ...
    asyncTest("persist ", function(done) {
        let deferred = $.Deferred();
        let combo = new ComboBox(parent, {
            dataValueField: "combo1Id",
            dataTextField: "text",
        ...
        deferred.done(function() {
            done(() => assert.equal(combo3.value(), "custom"));
        });
    });

    asyncTest("select the value of 3rd widget when it is bound and still not cascaded", function(done) {
        let combo = new ComboBox(parent, {
            optionLabel: "Select",
            dataValueField: "id",
            dataTextField: "text2",
        ...
        combo3.one("dataBound", function() {
            ...
            combo3.one("dataBound", function() {
                done(() => assert.equal(combo3.value(), "item2"));
            });
        });
    ...
    asyncTest("reset the value of 3rd widget in triple cascading scenario", function(done) {
        let combo = new ComboBox(parent, {
            optionLabel: "Select",
            dataValueField: "id",
            dataTextField: "text2",
        ...
        combo3.one("dataBound", function() {
            ...
            combo2.one("dataBound", function() {
                done(() => assert.equal(combo3.value(), ""));
            });
        });
    ...
    asyncTest("child selects correct item when multiple requests are started", function(done) {
        let productResults = [
            [{ ProductID: 1, ProductName: "Chai" }],
            [{ ProductID: 3, ProductName: "Aniseed Syrup" }]
        ];

        let combobox = new ComboBox(parent, {
            dataTextField: "CategoryName",
            dataValueField: "CategoryID",
            dataSource: {
                serverFiltering: true,
        ...
        let combobox2 = new ComboBox(child, {
            cascadeFrom: "parent",
            dataTextField: "ProductName",
            dataValueField: "ProductID",
            dataSource: {
    ...
    asyncTest("change event is triggered for all the comboboxes once the valie is manually changed", function(done) {
        let comboChangeCounter = 0;
        let combo = new ComboBox(parent, {
            optionLabel: "Select",
            dataValueField: "id",
            dataTextField: "text2",
