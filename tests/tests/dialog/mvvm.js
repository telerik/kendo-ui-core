...
describe("MVVM", function() {
    ...
    it("initializes a dialog when data role is dialog", function() {
        let dom = $('<div data-role="dialog"></div>');
    ...
    it("initializes a options from data attributes", function() {
        let dom = $('<div data-role="dialog" data-modal="true"></div>');

        kendo.bind(dom);

        let dialog = dom.data("kendoDialog");

        assert.equal(dialog.options.modal, true);
    });

    it("initializes modal false from data attributes", function() {
        let dom = $('<div data-role="dialog" data-modal="false"></div>');
    ...
    it("binding dialog initialized before binding", function() {
        let dom = $('<div data-modal="false"></div>');

        let dialog = dom.kendoDialog().data("kendoDialog");
    ...
    it("binding containing binding attributes", function() {
        let dom = $('<div data-role="dialog"><span data-bind="text:text"></span></div>');
    ...
    it("event is raised if attached as option", function() {
        let dom = $('<div data-role="dialog" data-open="openHandler"></div>');
    ...
    it("binding visible to true shows the dialog", function() {
        let dom = $('<div data-role="dialog" data-bind="visible: visible"></div>');
    ...
    it("binding invisible to true hides the dialog", function() {
        let dom = $('<div data-role="dialog" data-bind="invisible: invisible"></div>');
    ...
    it("bind visible through data attribute", function() {
        let dom = $('<div data-role="dialog" data-visible="false"></div>').appendTo(Mocha.fixture);
    ...
    it("set width and height through data attribute", function() {
        let dom = $('<div data-role="dialog" data-width="212" data-height="233"></div>').appendTo(Mocha.fixture);
    ...
    it("set content through data attribute", function() {
        let dom = $('<div data-role="dialog" data-content="echo"></div>').appendTo(Mocha.fixture);
