...
describe("ProgressBar initialization", function() {
    ...
    asyncTest("Start event is not fired on initialization when value is more than min", function(done) {
    ...
    it("ProgressBar is initialized correctly via data attribute", function() {
        let dom = $("<div data-role='progressbar'></div>");
    ...
    it("ProgressBar value is set correctly via data attribute", function() {
        let dom = $("<div data-role='progressbar' data-value='25'></div>");
        $(container).append(dom);
    ...
    it("ProgressBar type is set correctly via data attribute", function() {
        let dom = $("<div data-role='progressbar' data-type='chunk'></div>");
        $(container).append(dom);
    ...
    it("ProgressBar events are raised when set via data attribute", function() {
        let dom = $("<div data-role='progressbar' data-bind='events: {change: onPbChange}' data-animation='false'></div>");
        let fired = false;
...
describe("ProgressBar value initialization", function() {
    ...
    it("ProgressBar contains a nested empty div for progress wrapper when value is not equal to min and showStatus is false", function() {
        ...
        let progressWrapper = pb.wrapper.find(".k-selected");
    ...
    it("Size of progress wrapper div reflects value when value is not equal to min and showStatus is false", function() {
        ...
        let progressWrapperExpectedSize = pb._calculatePercentage().toFixed(2);
        let actualProgressWrapperSize = parseFloat(pb.wrapper.find(".k-selected")[0].style.width).toFixed(2);
    ...
    it("ProgressBar wrapper contains progress status holder when value is equal to min and showStatus is true", function() {
        ...
        let progressStatusHolder = pb.wrapper.children("span.k-progress-status-wrap");
    ...
    it("ProgressBar wrapper contains progress status holder and progress wrapper when value is not equal to min and showStatus is true", function() {
        ...
        let progressStatusHolder = pb.wrapper.children("span.k-progress-status-wrap");
        let progressWrapper = pb.wrapper.find(".k-selected");
        let progressWrapperStatusHolder = $("span.k-progress-status-wrap", progressWrapper);
...
describe("ProgessBar chunk initialization", function() {
    ...
    it("Correct css class is added to the completed chunks", function() {
        ...
        let completedChunks = pb.wrapper.find("li.k-progressbar-chunk:lt(2)");
    ...
    it("Chunk size is calculated correctly according to chunk count", function() {
        ...
        let chunkCount = pb.options.chunkCount;
        let expectedChunkSize = parseFloat(pb.wrapper.find("ul.k-reset li.k-progressbar-chunk:first")[0].style.width).toFixed(2);
        let actualChunkSize = (100 / chunkCount).toFixed(2);
