import { destroyListBox, createListBox, createListBoxWithToolbar } from "../../helpers/listbox-utils.js";
...
describe("ListBox initialization", function() {
    ...
    it("selectable should be destroyed on widget destroy", function() {
        listbox = new ListBox(div);
        let destroySpy = spy(listbox.selectable, "destroy");
...
describe("ListBox initialization", function() {
    ...
    it("toolbar is destroyed on widget destroy", function() {
        ...
        let destroySpy = spy(listbox.toolbar, "destroy");
