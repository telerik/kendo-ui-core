...
describe("Draggable auto scrolll", function() {
    ...
    it("scrollVelocity calculates velocity from rectangle and mouse position (top)", function() {
        let velocity = kendo.ui.Draggable.utils.autoScrollVelocity(30, 20, {
            top: 0,
            left: 0,
            bottom: 200,
            right: 200
    ...
    it("scrollVelocity calculates velocity from rectangle and mouse position (bottom)", function() {
        let velocity = kendo.ui.Draggable.utils.autoScrollVelocity(170, 180, {
            top: 0,
            left: 0,
            bottom: 200,
            right: 200
    ...
    it("scrollVelocity calculates velocity from rectangle and mouse position (center)", function() {
        let velocity = kendo.ui.Draggable.utils.autoScrollVelocity(100, 100, {
            top: 0,
            left: 0,
            bottom: 200,
            right: 200
    ...
    it("scrollable view port calculates element dimensions", function() {
        let el = $("<div style='width: 200px; height:300px; position: absolute; top: 100px; left: 200px;'>Div</div>").appendTo(Mocha.fixture);
        let dimensions = kendo.ui.Draggable.utils.scrollableViewPort(el);
    ...
    it("scrollable parent gets the element if scrollalble", function() {
        let el = $("<div style='width: 200px; height:300px; position: absolute; top: 100px; left: 200px; overflow: auto'>Div</div>").appendTo(Mocha.fixture);
        let parent = kendo.ui.Draggable.utils.findScrollableParent(el);
