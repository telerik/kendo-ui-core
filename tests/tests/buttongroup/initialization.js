import { setupEmptyButtonGroup, initializeButtonGroup, destroyButtonGroup } from "../../helpers/buttongroup.js";
...
describe("kendo.ui.ButtonGroup initialization", function() {
    ...
    it("k-icon-button is added when only icon rendered", function() {
        ...
        let firstButton = buttonGroup.element.children().eq(0);
    ...
    it("icon is added via iconClass option", function() {
        ...
        let iconEl = buttonGroup.element.children().eq(0).children();
    ...
    it("k-selected is added with custom attributes and multiple selection", function() {
        ...
        let secondButton = buttonGroup.element.children().eq(1);
    ...
    it("k-selected on a button is passed to the selectedIndices array", function() {
        $('#buttonGroup').append($('<span>item0</span>'));
        $('#buttonGroup').append($('<span class="k-selected">item2</span>'));
        buttonGroup = initializeButtonGroup();
    ...
    it("when badge is enabled a kendo.ui.Badge is initialized", function() {
        ...
        let badge = buttonGroup.element.children().eq(0).find('.k-badge').data('kendoBadge');
