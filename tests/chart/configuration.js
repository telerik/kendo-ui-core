(function() {
    (function() {
        ...
        function setupChart(options, element) {
            chart = createChart(options, element);
            plotArea = chart._model.children[1];
        }

        function createBarChart(options, element) {
            setupChart($.extend({
                series: [{
                    type: "bar",
                    data: [1, 2]
        ...
        function createScatterChart(options, element) {
            setupChart($.extend({
                series: [{
                    type: "scatter",
                    data: [[1, 1]]
        ...
        test("sets dimensions on view element", 2, function() {
            chart = $("<div id='container' />").kendoChart().data("kendoChart");
        ...
        test("picks width from container", function() {
            chart = $("<div id='container' />").width("100px").kendoChart().data("kendoChart");
            equal(chart._model.options.width, 100);
        });

        test("picks height from container", function() {
            chart = $("<div id='container' />").height("100px").kendoChart().data("kendoChart");
            equal(chart._model.options.height, 100);
        });

        test("picks width from container on refresh", function() {
            chart = $("<div id='container' />").width("200px").kendoChart().data("kendoChart");
            chart.refresh();
        ...
        test("picks height from container on refresh", function() {
            chart = $("<div id='container' />").height("200px").kendoChart().data("kendoChart");
            chart.refresh();
