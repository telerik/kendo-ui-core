...
![{{ site.product_short }} Access Level](../images/azure-blob-storage-container-access.png)
...
![{{ site.product_short }} Access Keys](../images/azure-blob-storage-access-keys.png)
