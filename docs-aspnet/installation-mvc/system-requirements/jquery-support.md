...
Telerik UI for ASP.NET MVC is a set of server-side wrappers over the Kendo UI for jQuery widgets.
...
* [Operating System and Browser Support by Telerik UI for ASP.NET MVC]({% slug webbrowsersupport_aspnetmvc %})
