...
description: "Get started with Telerik UI for ASP.NET MVC, customize its components according to your project and add only the helpers that you need."
previous_url: /getting-started/scripts/what-you-need, /installation/scripts/what-you-need
slug: custombundles_mvc
position: 1
---
...
* [Check out the operation system and web browser support]({% slug webbrowsersupport_aspnetmvc %})
