---
title: Using AJAX Binding in Grid
description: An example on how to use AJAX calls to populate the {{ site.product }} Grid HtmlHelper.
type: how-to
...
How can I use AJAX calls to populate a Grid HTML helper when working with {{ site.product }}?
