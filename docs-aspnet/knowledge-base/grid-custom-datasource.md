---
title: Configuring a Custom DataSource for the Grid
description: An example on how to configure a custom DataSource to populate a {{ site.product }} Grid HtmlHelper.
type: how-to
...
How can I configure a custom DataSource for the Grid HtmlHelper when working with the {{ site.product }} components?
