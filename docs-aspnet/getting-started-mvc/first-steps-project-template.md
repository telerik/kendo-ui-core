...
For more information on how to use the Visual Studio extension to set up new projects, refer to the [creating new {{ site.product }} projects article](https://docs.telerik.com/aspnet-mvc/vs-integration/new-project-wizard).
