...
1. Use the [Radial Gauge client-side API](https://www.telerik.com/kendo-jquery-ui/documentation/api/dataviz/ui/radialgauge#methods) to control the behavior of the component. In this example, you will use the [`value()`](https://www.telerik.com/kendo-jquery-ui/documentation/api/dataviz/ui/radialgauge/methods/value) method to change the value of the Radial Gauge when the user presses the `ArrowUp` or `ArrowDown` keyboard buttons.
...
* [Client-Side API of the Radial Gauge](https://www.telerik.com/kendo-jquery-ui/documentation/api/dataviz/ui/radialgauge)
