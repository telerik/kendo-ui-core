...
1. Use the [ToggleButton client-side API](https://docs.telerik.com/kendo-ui/api/ui/togglebutton#methods) to control the behavior of the widget. In this example, you will use the `enable` method to disable the component. The method is inherited from the Button widget.
