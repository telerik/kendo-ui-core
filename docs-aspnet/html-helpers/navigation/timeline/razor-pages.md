...
1. Specify the Read request URL in the `DataSource` configuration. The URL must refer to the method name in the `PageModel`.
    ...
    ```HtmlHelper
        .DataSource(dt => dt
            .Read(r=>r.Url(Url.Page("TimelineBinding", "Events")))
        )
    ```
    {% if site.core %}
    ```TagHelper
        <datasource>
            <transport>
                <read url="@Url.Page("TimelineBinding", "Events")" />
            </transport>
        </datasource>
    ```
    {% endif %}
        ...
        if (Events == null)
        {
            ...
            Events.Add(new TimelineEventModel()
            {
                ...
                Actions = new List<TimelineEventModelAction>() 
                {
                    ...
                    { 
                        text = "More info about Barcelona", url="https://en.wikipedia.org/wiki/Barcelona" 
                    }
                }
            });
            ...
            Events.Add(new TimelineEventModel()
            {
                ...
                Actions = new List<TimelineEventModelAction>() 
                {
                    new TimelineEventModelAction() 
                    { 
                        text = "More info about New York City", url="https://en.wikipedia.org/wiki/New_York_City" 
                    }
                }
            });
            ...
            Events.Add(new TimelineEventModel()
            {
                ...
                Actions = new List<TimelineEventModelAction>() 
                {
                    new TimelineEventModelAction() 
                    { 
                        text = "More info about Malta", url="https://en.wikipedia.org/wiki/Malta" 
                    }
                }
            });
            ...
            Events.Add(new TimelineEventModel()
            {
                ...
                Actions = new List<TimelineEventModelAction>() 
                {
                    new TimelineEventModelAction() 
                    { 
                        text = "More info about Munich", url="https://en.wikipedia.org/wiki/Munich" 
                    }
                }
            });
        }
