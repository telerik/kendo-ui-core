...
1. Use the [TabStrip client-side API](https://docs.telerik.com/kendo-ui/api/ui/tabstrip#methods) to control the behavior of the widget. In this example, you will use the `select` method to select an item.
