...
|  | `aria-hidden=true` | Only if the component implements a feature to control whether the content must be persisted. |
...
The TabStrip is fully compliant with the [Section 508 requirements](https://www.section508.gov/).
