---
title: Overview
page_title: SegmentedControl Documentation | SegmentedControl Accessibility
description: "Get started with the {{ site.product }} SegmentedControl and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.2."
components: ["segmentedcontrol"]
slug: htmlhelpers_segmentedcontrol_accessibility
position: 1
---

# SegmentedControl Accessibility

Out of the box, the {{ site.product }} SegmentedControl provides accessibility support and enables users with disabilities to acquire complete control over its features.
...
For details on how the SegmentedControl keyboard navigation works, refer to the [SegmentedControl Keyboard Navigation]({%slug keynav_aspnetcore_segmentedcontrol%}) article.

## See Also

* [Keyboard Navigation by the SegmentedControl for {{ site.framework }} (Demo)](https://demos.telerik.com/{{ site.platform }}/segmentedcontrol/keyboard-navigation)
* [Keyboard Navigation by the SegmentedControl for {{ site.framework }}]({% slug keynav_aspnetcore_segmentedcontrol %})
