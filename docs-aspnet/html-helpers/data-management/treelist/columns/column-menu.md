...
> When the `ColumnMenu` configuration is enabled, the TreeList fires the client-side [`columnMenuInit`](https://docs.telerik.com/kendo-ui/api/ui/treelist/events/columnmenuinit) and [`columnMenuOpen`](https://docs.telerik.com/kendo-ui/api/ui/treelist/events/columnmenuopen) events instead of [`filterMenuInit`](https://docs.telerik.com/kendo-ui/api/ui/treelist/events/filtermenuinit) and [`filterMenuOpen`](https://docs.telerik.com/kendo-ui/api/ui/treelist/events/filtermenuopen).
