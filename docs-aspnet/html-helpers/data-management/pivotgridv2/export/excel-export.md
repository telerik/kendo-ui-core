...
To export the PivotGridV2, call the [`saveAsExcel()`](https://www.telerik.com/kendo-jquery-ui/documentation/api/ui/pivotgrid/methods/saveasexcel) client-side API method of the component.
