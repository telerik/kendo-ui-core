---
title: Overview
page_title: Telerik UI Diagram Documentation | Diagram Accessibility
description: "Get started with the Telerik UI Diagram component for {{ site.framework }} and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.2."
components: ["diagram"]
slug: htmlhelpers_diagram_accessibility
position: 1
---

# Diagram Accessibility

Out of the box, the {{ site.product }} Diagram provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
The Diagram is fully compliant with the [Section 508 requirements](https://www.section508.gov/).
...
To test the Diagram component, refer to the [Diagram Accessibility Demo](https://demos.telerik.com/{{ site.platform }}/accessibility/diagram).

## Keyboard Navigation

For details on how the Diagram keyboard navigation works, refer to the [Diagram Keyboard Navigation](slug:keynav_diagram_aspnetcore) article.
