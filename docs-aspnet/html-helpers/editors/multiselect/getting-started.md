...
1. Use the [MultiSelect client-side API](https://docs.telerik.com/kendo-ui/api/ui/multiselect#methods) to control the behavior of the widget. In this example, you will use the `value` method to select an item.
