---
title: Overview
page_title: TextBox Documentation | TextBox Accessibility
description: "Get started with the {{ site.product }} TextBox and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.2."
...
Out of the box, the {{ site.product }} TextBox provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
The TextBox is fully compliant with the [Section 508 requirements](https://www.section508.gov/).
...
To test the TextBox component, refer to the [TextBox Accessibility Demo](https://demos.telerik.com/{{ site.platform }}/accessibility/textbox).
