...
|  | `tabindex=0/-1` | The element must be focusable. Value must be changed dynamically based on the roving tabindex navigation. |
...
The Upload is fully compliant with the [Section 508 requirements](https://www.section508.gov/).
