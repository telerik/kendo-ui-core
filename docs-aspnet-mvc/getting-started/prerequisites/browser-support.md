...
Most [Telerik UI for ASP.NET MVC helpers]({% slug overview_aspnetmvc %}#list-of-helpers) have no specific limitations as of the browser versions they support.
...
The [Telerik UI for ASP.NET MVC helpers which render data visualization]({% slug overview_aspnetmvc %}#list-of-helpers), such as the Charts, Gauges, Barcodes, Diagrams, and Maps, may require more recent browser versions according to the following table.
