...
Progress Telerik UI for ASP.NET MVC requires ASP.NET MVC.
...
Progress Telerik UI for ASP.NET MVC supports:
...
Progress Telerik UI for ASP.NET MVC Visual Studio Extensions support Visual Studio 2010 and later.

## Download

To download Progress Telerik UI for ASP.NET MVC:
...
Run Progress Telerik UI for ASP.NET MVC installer. The automatic setup will guide you through the rest of the installation. If you chose to download the `.zip` file, extract it to a location of your preference.

### Location

The setup installs Progress Telerik UI for ASP.NET MVC in `C:\Program Files (x86)\Telerik\UI for ASP.NET MVC<version>`.

### Distribution Contents

Progress Telerik UI for ASP.NET MVC contains the following directories:
...
Progress Telerik UI for ASP.NET MVC comes with a sample ASP.NET MVC application available in 2 versions:
...
1. Navigate to the installation directory of Progress Telerik UI for ASP.NET MVC.
...
1. A browser loads the start page of the sample application. Use the links to explore the available demos.
    ...
    **Figure 1 The start-up screen of the sample application**
    ...
    ![Progress Telerik UI for ASP.NET MVC Sample Application](/images/demos.png)
...
You can upgrade the version of the Progress Telerik UI for ASP.NET MVC wrappers and also switch from a trial to a developer license.

### Upgrade to Newer Versions

To update Progress Telerik UI for ASP.NET MVC to a new version, either:
...
To manually upgrade to a newer Progress Telerik UI for ASP.NET MVC version:

1. Replace all [scripts, styles, and images](#distribution-contents) related to Progress Telerik UI for ASP.NET MVC with the desired version of the framework. [Download](#download) the desired version from the **Download** section of your account.
...
1. [Install](#installation) the licensed Kendo UI version and follow the steps for updating the Progress Telerik UI for ASP.NET MVC version.
...
As of the [Kendo UI R1 2017 release](http://docs.telerik.com/kendo-ui/backwards-compatibility/2017-backward-compatibility#kendo-ui-2017-r1), the Progress Telerik UI for ASP.NET MVC uses [font icons](http://docs.telerik.com/kendo-ui/styles-and-layout/icons-web), which might lead to compatibility issues.
...
After you run the sample application, read through the following articles, related to Progress Telerik UI for ASP.NET MVC:
...
* [Use Progress Telerik UI for ASP.NET Core](../aspnet-core/introduction)
...
* [Collected Examples on Progress Telerik UI for ASP.NET MVC](https://github.com/telerik/ui-for-aspnet-mvc-examples)
