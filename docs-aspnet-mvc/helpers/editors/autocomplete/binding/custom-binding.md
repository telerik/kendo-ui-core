...
page_title: Custom Binding | Telerik UI AutoComplete HtmlHelper for ASP.NET MVC
description: "Learn how to implement custom binding with Telerik UI AutoComplete HtmlHelper for ASP.NET MVC."
...
```ASPX
    <%: Html.Kendo().AutoComplete()
        .Name("productAutoComplete")
        .DataTextField("ProductName") // Specify which property of the Product will be used by the AutoComplete as text.
        .DataSource(source =>
        {
            source.Custom()
                  .ServerFiltering(true)
