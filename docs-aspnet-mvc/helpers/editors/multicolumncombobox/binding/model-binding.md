---
title: Model Binding
page_title: Model Binding | Telerik UI MultiColumnComboBox HtmlHelper for ASP.NET MVC
description: "Learn how to implement model binding with Telerik UI MultiColumnComboBox HtmlHelper for ASP.NET MVC."
