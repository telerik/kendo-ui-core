...
This project demonstrates how to implement a [custom MVVM binding](http://docs.telerik.com/kendo-ui/framework/mvvm/overview) and disable the default value binding for a ComboBox to prevent the initial binding when a selected value is set. This approach can be used to avoid the default [value binding](http://docs.telerik.com/kendo-ui/framework/mvvm/bindings/value#value-binding-of-elements-select) behavior when the ComboBox is bound to a great amount of data.
