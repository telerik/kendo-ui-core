...
ICENIUM_MIN_CSS = FileList['styles/mobile/kendo.icenium.min.css'].include(ICENIUM_MIN_RESOURCES).include(DATAVIZ_MIN_CSS).exclude('styles/dataviz/kendo.dataviz.min.css')
