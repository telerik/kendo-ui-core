...
Kendo UI allows you to freeze both columns and rows by using the [`freezePane`](/api/ooxml/workbook/configuration/sheets#sheetsfreezepane) option.

## Rows

Freezing the first row of an Excel sheet is a common requirement. It allows you to scroll the rest of the document without losing the header. To freeze rows, set the [`rowSplit`](/api/ooxml/workbook/configuration/sheets#sheetsfreezepane#sheetsfreezepanerowsplit) option to the number of rows you want to freeze.
...
To freeze columns, set the [`colSplit`](/api/ooxml/workbook/configuration/sheets#sheetsfreezepane#sheetsfreezepanecolsplit) option to the number of columns you want to freeze.
