...
To manually set the column width in pixels, use the [`width`](/api/ooxml/workbook/configuration/sheets#sheetscolumns#sheetscolumnswidth) option.
...
To enable the automatic width calculation, set the [`autoWidth`](/api/ooxml/workbook/configuration/sheets#sheetscolumns#sheetscolumnsautowidth) option to `true`. When set, the he column stretches to accommodate the longest cell value.
