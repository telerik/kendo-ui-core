...
![Kendo UI for jQuery Nested ListView with different color scheme](ListView-in-Drawer.png)
...
![Kendo UI for jQuery Nested Vertical TabStrip](TabStrip-in-Drawer.png)
