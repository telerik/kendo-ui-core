...
To add a prefix before your MaskedTextBox input, use the [`prefixOptions`](/api/ui/maskedtextbox/configuration/prefixoptions) configuration. `prefixOptions` provides the following options:
...
To add a suffix after your MaskedTextBox input, use the [`suffixOptions`](/api/ui/maskedtextbox/configuration/suffixoptions). `suffixOptions` provides the following options:
