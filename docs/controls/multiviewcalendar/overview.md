...
* [Accessibility]({% slug jquery_multiviewcalendar_accessibility %})&mdash;The MultiViewCalendar is accessible for screen readers, supports WAI-ARIA attributes, and delivers keyboard shortcuts for faster navigation.
