...
Configure accessibility attributes for connections using the [`connectionDefaults.accessibility`](/api/dataviz/ui/diagram/configuration/connectiondefaults#connectiondefaultsaccessibility) option.
