...
The following example demonstrates how the set the configuration for the Steps of the Stepper through the [`steps`](/api/ui/stepper/configuration/steps) configuration.
