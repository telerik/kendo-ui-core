...
The [Kendo UI Filter component](https://demos.telerik.com/kendo-ui/filter/index) a unified control for filtering data-bound components that have a [data source](/api/data/datasource).
