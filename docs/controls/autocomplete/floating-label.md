...
To implement a [floating label in the Kendo UI for jQuery AutoComplete](/api/ui/autocomplete/configuration/label), define it either as a string or from a function.
