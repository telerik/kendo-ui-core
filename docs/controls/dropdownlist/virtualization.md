...
![Kendo UI for jQuery DropDownList Virtualization Process](../virtualization-mapValueTo-index.png)
...
![Kendo UI for jQuery DropDownList Virtualization Process](../virtualization-mapValueTo-dataItem.png)
