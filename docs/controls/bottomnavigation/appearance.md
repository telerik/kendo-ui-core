...
The Kendo UI BottomNavigation allows you to alter the appearance of the widget by setting its [itemFlow](/api/ui/bottomnavigation/configuration/itemflow), [themeColor](/api/ui/bottomnavigation/configuration/themeColor), [border](/api/ui/bottomnavigation/configuration/border), [shadow](/api/ui/bottomnavigation/configuration/shadow) and [fillMode](/api/ui/bottomnavigation/configuration/fillmode) options.
