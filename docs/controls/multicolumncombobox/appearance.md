...
With the new rendering different classes should be used in order to customize the [MultiColumnComboBox templates](/controls/multicolumncombobox/templates).
