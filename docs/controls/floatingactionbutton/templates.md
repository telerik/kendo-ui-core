...
The [`items.template`](/api/ui/floatingactionbutton/configuration/items#itemstemplate) configuration options manages the way the speed dial action items of a FloatingActionButton are rendered.
