...
To see the example on the remote CRUD (Create, Read, Update, Destroy) data operations using WCF service. To see the example, refer to [this project](https://github.com/telerik/kendo-examples-asp-net/tree/master/grid-wcf-crud). It is available in the [GitHub repository for Kendo UI examples using ASP.NET Web technologies](https://github.com/telerik/kendo-examples-asp-net).
