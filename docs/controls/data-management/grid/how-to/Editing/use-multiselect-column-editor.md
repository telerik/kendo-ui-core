...
page_title: jQuery Grid Documentation | MultiSelect for Column Editor | Kendo UI
description: "Get started with the jQuery Grid by Kendo UI and learn how to use MultiSelect for a column editor in the widget."
