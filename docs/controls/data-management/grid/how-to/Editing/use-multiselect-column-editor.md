...
description: "Learn how to use a Kendo UI MultiSelect for a column editor."
slug: howto_use_multiselect_column_editor
---

# Use MultiSelect for Column Editor

This article illustrates how to use a Kendo UI MultiSelect for a column editor. To see the example, refer to the [example source code](https://github.com/telerik/kendo-examples-asp-net-mvc/tree/master/multiselect-in-grid), which is available in the [Kendo UI ASP.NET MVC code samples GitHub repository](https://github.com/telerik/kendo-examples-asp-net-mvc).
