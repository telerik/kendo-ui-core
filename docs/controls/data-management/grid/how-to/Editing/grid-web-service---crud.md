...
To see the example on the remote CRUD (Create, Read, Update, Destroy) data operations using ASMX service, refer to [this project](https://github.com/telerik/kendo-examples-asp-net/tree/master/grid-web-service-crud). It is available in the [GitHub repository for Kendo UI examples using ASP.NET Web technologies](https://github.com/telerik/kendo-examples-asp-net).
