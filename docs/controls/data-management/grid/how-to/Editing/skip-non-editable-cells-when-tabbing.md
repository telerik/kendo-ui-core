...
Normally, tabbing in an editable Grid will step on each cell, no matter if it is editable or not. The example below demonstrates how to skip non-editable cells during tabbing the Kendo UI Grid.
