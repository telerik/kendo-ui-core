...
To implement a [floating label in the Kendo UI for jQuery DatePicker](/api/ui/datepicker/configuration/label), define it either as a string or from a function.
