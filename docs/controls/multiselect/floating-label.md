...
To implement a [floating label in the Kendo UI for jQuery MultiSelect](/api/ui/multiselect/configuration/label), define it either as a string or from a function.
