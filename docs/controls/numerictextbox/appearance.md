...
In this article, you will find information about the styling options and rendering of the Kendo UI NumericTextBox.
...
The following values are available for the [`size`](/api/ui/numerictextbox/configuration/size) option:
...
The following values are available for the [`rouned`](/api/ui/numerictextbox/configuration/rounded) option:
...
The following values are available for the [`fillMode`](/api/ui/numerictextbox/configuration/fillmode) option:
