...
The component uses the Kendo ContextMenu, enabling you to get full advantage of its [Client API](/api/ui/filemanager). Once an item is selected, the corresponding command is executed. 
