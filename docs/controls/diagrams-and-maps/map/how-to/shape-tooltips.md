...
page_title: Display Shape Tooltips
description: Configuring per-shape tooltips in the Kendo UI Map Shape Layer
---

# Display Shape Tooltips

The example below demonstrates how to display a tooltip for individual shapes.

#### Example: Display Shape Tooltips
