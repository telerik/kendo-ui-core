...
| Wrap content				| <ol><li>Select a cell that contains the content you want to wrap.</li> <li>Click **Wrap Text** [ <span class="k-icon k-font-icon k-i-text-wrap"></span> ] on the **Toolbar**.</li></ol> |
...
| Wrap content				| <ol><li>Select a row.</li> <li>Click **Wrap Text** [ <span class="k-icon k-font-icon k-i-text-wrap"></span> ] on the **Toolbar**.</li></ol> |
...
| Wrap content			| <ol><li>Select the column whose content you want to wrap.</li> <li>Click **Wrap Text** [ <span class="k-icon k-font-icon k-i-text-wrap"></span> ] on the **Toolbar**.</li></ol> |
