...
As of the end of 2021, the FlatColorPicker has a new design. One of the introduced new features is the [views](/api/ui/flatcolorpicker/configuration/views) configuration. It allows you to choose between a `gradient` and a `palette` view. You can also choose which the default view would be through the [view](/api/ui/flatcolorpicker/configuration/view) option.
