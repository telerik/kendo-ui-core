...
Here, you will specify the [`colors`](/api/dataviz/ui/circulargauge/configuration/colors) of the value pointer. The color of the pointer will change based on the current value of the CircularGauge component. 
...
To see the full list of the CircularGauge scale configuration options, see the [CircularGauge API](/api/dataviz/ui/circulargauge/configuration/scale).
...
By default, the CircularGauge does not render content in the center. To add content and modify it according to your preferences, use the [`centerTemplate`](/api/dataviz/ui/circulargauge/configuration/centertemplate).
