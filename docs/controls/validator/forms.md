...
For details on setting up the Kendo Validator and the usage of the built-in validation rules and creating custom validation rules refer to the [Validation Rules section.]({% slug rules_kendoui_validator %})
