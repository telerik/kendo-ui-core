...
To export the charts of the ChartWizard component to PDF, PNG, or SVG formats, set the desired properties in the [`exportOptions`](/api/ui/chartwizard/configuration/exportoptions) object.

You can configure the parameters of the exported image by setting the image property to an [`exportOptions.image`](/api/ui/chartwizard/configuration/exportoptions#exportoptionsimage) object and the exported PDF file by utilizing the [`exportOptions.pdf`](/api/ui/chartwizard/configuration/exportoptions#exportoptionspdf) object.
