---
title: Update Event End Time On Click
page_title: Update Event End Time On Click | Kendo UI Scheduler
description: "Learn how to update event's end time on click in a Kendo UI Scheduler widget."
slug: howto_update_event_end_time_on_click_scheduler
---

# Create Custom Views Inheriting Built-In Views

The example below demonstrates how to update event's end time on click in the Kendo UI Scheduler widget.
