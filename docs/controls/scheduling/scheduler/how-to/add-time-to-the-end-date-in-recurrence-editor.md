---
title: Add Time to the End Date of a Recurring Event
page_title: Add Time to the End Date of a Recurring Event | Kendo UI Scheduler
description: "Add Time to the End Date of a Recurring Event"
slug: howto_add_time_to_the_end_date_of_a_recurring_event_scheduler
---

# Add Time to the End Date of a Recurring Event

The example below demonstrates how to format the end date of a recurring event. 
