...
page_title: Add Events Programatically | Kendo UI Scheduler Widget
description: "Learn how to programatically add an event to the Kendo UI Scheduler widget."
slug: howto_add_events_programatically_scheduler
---

# Add Events Programatically

The example below demonstrates how to programatically add an event to the Kendo UI Scheduler widget.
