...
* ***2.5.8:** Target Size (Minimum)*
  ...
  The size of [Series Markers](https://docs.telerik.com/kendo-ui/api/dataviz/ui/chart/configuration/series#seriesmarkers) and the font size of [Legend Items](https://docs.telerik.com/kendo-ui/api/dataviz/ui/chart/configuration/legend#legenditem) may need to be customized to meet the minimum size of 24x24px required by this criteria.
