...
> * To render a legend item for the Pie, Donut and Funnel series, provide the items with a [`categoryField`](/api/dataviz/ui/chart/configuration/series#seriescategoryfield).
...
The following example demonstrates how to hide the legend by using its [`visible`](/api/dataviz/ui/chart/configuration/legend#legendvisible) property.
...
To exclude series from the legend, set their [`visibleInLegend`](/api/dataviz/ui/chart/configuration/series#seriesvisibleinlegend) option to `false`.
...
To customize the legend item for each series, use the series [`legendItem`](/api/dataviz/ui/chart/configuration/series#serieslegenditem) options.
...
To configure the legend items for all series, use the legend [`seriesDefaults.legendItem`](/api/dataviz/ui/chart/configuration/seriesdefaults#seriesdefaultslegenditem) option.
...
To define a title, provide a [`title`](/api/dataviz/ui/chart/configuration/legend#legendtitle) object to the legend configuration.
