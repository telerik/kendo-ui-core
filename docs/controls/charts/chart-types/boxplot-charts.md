...
* [`series.outliers`](/api/dataviz/ui/chart/configuration/series.outliers) for mild outliers.
* [`series.extremes`](/api/dataviz/ui/chart/configuration/series.extremes) for extreme outliers.
