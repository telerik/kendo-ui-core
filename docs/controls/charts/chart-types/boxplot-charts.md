...
* [`series.outliers`](/api/dataviz/ui/chart/configuration/series#seriesoutliers) for mild outliers.
* [`series.extremes`](/api/dataviz/ui/chart/configuration/series#seriesextremes) for extreme outliers.
