...
The content of each Wizard step can be specified via the [`steps.content`](/api/ui/wizard/configuration/steps#stepscontent) or [`steps.contentId`](/api/ui/wizard/configuration/steps#stepscontentid) configuration options. In this way a specific HTML string or a DOM element, specified by its Id, will be used as content:
