...
To implement a [floating label in the Kendo UI for jQuery DateTimePicker](/api/ui/datetimepicker/configuration/label), define it either as a string or from a function.
