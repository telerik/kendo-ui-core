...
The following values are available for the [`size`](/api/ui/datetimepicker/configuration/size) option:
...
The following values are available for the [`rounded`](/api/ui/datetimepicker/configuration/rounded) option:
...
The following values are available for the [`fillMode`](/api/ui/datetimepicker/configuration/fillmode) option:
