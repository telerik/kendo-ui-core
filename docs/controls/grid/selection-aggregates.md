...
The aggregates are configured inside the selectable configuration of the Grid through the [`cellAggregates`](/api/ui/grid/configuration/selectable#selectablecellaggregates) property. 
