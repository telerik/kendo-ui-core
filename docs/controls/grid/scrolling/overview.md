...
1. Save the scroll position in the [`dataBinding`](/api/ui/grid/events/databinding) event.
1. Restore the scroll position in the [`databound`](/api/ui/grid/events/databound) event.
