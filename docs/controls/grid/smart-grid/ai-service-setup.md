...
Now that your backend is ready, configure your Kendo UI for jQuery Grid to use this API endpoint. See [Smart Grid AI Assistant Tools Setup](slug:ai_assistant_tools_setup) for frontend setup options.
