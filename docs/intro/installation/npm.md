...
description: "Get started with Kendo UI for jQuery and install Kendo UI Core or Kendo UI Professional as NPM packages."
...
Kendo UI maintains the [Kendo UI Core](#kendo-ui-core-on-npm) and the [Kendo UI Professional](#kendo-ui-professional-on-npm) NPM packages. All Kendo UI official releases, service packs, and internal builds are uploaded to both of them.

> The Kendo UI Professional NPM package is available only for commercial license holders. For more information, refer to the [list of Kendo UI components and their bundle support]({% slug welcometo_kendoui %}#list-of-widgets).
