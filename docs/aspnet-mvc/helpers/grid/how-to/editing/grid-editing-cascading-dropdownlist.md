...
description: "Configure the Grid to handle cascading DropDownLists within the Grid when using the Popup or Inline editing modes."
slug: howto_handleeditingcascadingddls_gridaspnetmvc
---

# Handle Cascading DropDownLists within the Grid

To see the example on how to configure the Kendo UI Grid to handle cascading DropDownLists within itself when using the popup or inline editing modes, refer to [this project](https://github.com/telerik/ui-for-aspnet-mvc-examples/tree/master/grid/grid-editing-cascading-dropdownlist).
