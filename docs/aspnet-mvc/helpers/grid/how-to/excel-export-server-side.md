...
description: "Export the Kendo UI Grid data as an Excel document."
...
To see the example on how to export to Excel server-side, refer to [this project](https://github.com/telerik/ui-for-aspnet-mvc-examples/tree/master/grid/excel-export-server-side).
