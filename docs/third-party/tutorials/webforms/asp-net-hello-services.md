...
**Figure 7. Employee Controller Inherits API Controller Class**
...
**Figure 8. Return a LINЯ Тo SQL Object**
...
**Figure 13. Add jQuery To Master Page**
...
**Figure 14. `F12` Content Type Inspection**
...
**Figure 16. Delete Not Implemented**
...
**Web API** is a maturing library and is baked into the next official release
of MVC 4. For now, the following screencasts should help you become quite
familiar with using Web API in MVC 4.

[Web API With MVC 4 Screencast Series](http://weblogs.asp.net/jgalloway/archive/2012/03/16/asp-net-web-api-screencast-series-with-downloadable-sample-code-part-1.aspx)
