---
title: Drill-down navigation starting always from root tuple
page_title: Drill-down navigation starting always from root tuple
description: Drill-down navigation starting always from root tuple
---

# Drill-down navigation starting always from root tuple

The example below demonstrates how to change the widget's configuration on member expand. Thus the widget drills down on expand, but always starting from the expanded member.
