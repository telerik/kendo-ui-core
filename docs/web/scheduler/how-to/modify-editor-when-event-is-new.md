---
title: Modify editor template when event is new
page_title: Modify editor template when event is new
description: Modify editor template when event is new
---

# Modify editor template when event is new

The example below demonstrates how to show/hide different parts of the editor template based on
the event state. The demo hides the 'Title' field if the event is **not new** and shows a message.
