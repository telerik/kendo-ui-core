...
| Hide					| <ol><li>Select the row(s) by clicking on the respective row header</li> <li>Right-click the row header</li> <li>Choose **Hide**</li></ol> |
...
| Delete				| <ol><li>Select the column(s) by clicking on the respective column header</li> <li>In the **Menu** click **Insert**</li> <li>On the **Toolbar** click **Delete Column** [ <span class="k-font-icon k-i-delete-column"></span> ]</li></ol> |
...
| WHAT YOU WANT			| HOW TO GET THERE		|
| :---					| :---					|
| Choose fonts			| <ol><li>Select the cell(s) to which you want to apply the font</li> <li>On the **Toolbar** click **Font** [ <span class="k-font-icon k-i-font-family"></span> ]</li> <li>Choose a font type from the drop-down list</li></ol> |
| Edit font sizes 	| <ol><li>Select the cell(s) to which you want to apply the font size</li> <li>On the **Toolbar** click **Font Size** [ <span class="k-font-icon k-i-font-size"></span> ]</li> <li>Choose the font size from the predetermined values in drop-down list</li></ol> |
