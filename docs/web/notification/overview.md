...
For more information on Notification templates, refer to the [Templates help section](#templates).
...
When a popup notification message from a given stack is hidden, the remaining visible popups do not move. If automatic moving and repositioning is desired, it can be achieved, as shown in the [Move Visible Notifications after Hiding Others](/web/notification/how-to/move-on-notification-hide) how-to article.
