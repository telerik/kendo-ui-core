...
Specifies the number format used when the widget is not focused. Check this page for all [valid number formats](/kendo-jquery-ui/documentation/globalization/intl/numberformatting).
