...
The `kendo.data.OrgChartModel` class represents a data item from the [kendo.data.OrgCharttDataSource](/api/data/orgchartdatasource). Inherits from [kendo.data.Model](/api/data/model).
