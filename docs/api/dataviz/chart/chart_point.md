...
The sum of point values since the last "runningTotal" [summary point](/api/dataviz/ui/chart/configuration/series#seriessummaryfield). Available for waterfall series points.
