...
> For Kendo UI releases 2017 R1 or later use the built-in [`columns.command.visible`](/api/ui/grid/configuration/columns#columnscommand#columns.command.visible) function of the Grid instead.
