...
1. When needed, restore the filter status by using the [`filter()`](https://docs.telerik.com/kendo-ui/api/spreadsheet/range/methods/filter) method of the `Range` object.
