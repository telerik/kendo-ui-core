...
1. Configure the CRUD operations for the Grid in which you want to implement the copy-paste functionality by using a [`batch`](https://docs.telerik.com/kendo-ui/api/data/datasource/configuration/batch) data source to send all the requests at once.
