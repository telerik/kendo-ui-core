...
## Solution
1. Get the Spreadsheet's [`activeSheet`](https://docs.telerik.com/kendo-ui/api/ui/spreadsheet/methods/activesheet)
...
1. In the callback of the map method use the [`sheet.range`](https://docs.telerik.com/kendo-ui/api/spreadsheet/sheet/methods/range) method to get the [`Range`](https://docs.telerik.com/kendo-ui/api/spreadsheet/range) of the formula cells currently being mapped and return it to enable later manipulation
