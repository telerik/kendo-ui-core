...
1. In the ToolBar [`items.template`](/api/ui/toolbar/configuration/items#itemstemplate) add an element from which you can initialize a [`Kendo Popup`](/api/ui/popup).
