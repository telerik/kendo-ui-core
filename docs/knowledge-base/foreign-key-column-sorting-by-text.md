...
page_title: ForeignKey Column Sorting by Text - Kendo UI for jQuery Data Grid
description: "Learn how to enable ForeignKey column sorting by text in the Kendo UI Grid for jQuery."
