---
title: Persist All Changes with a Single Request in the Scheduler
page_title: Persist All Changes with a Single Request in the Scheduler
description: "Learn how to persist all changes in a Kendo UI for jQuery Scheduler with a single request."
...
How can I persist all changes with a single request in the Kendo UI for jQuery Scheduler?
