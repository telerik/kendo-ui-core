...
The [`legend.item.visual`](/api/dataviz/ui/chart/configuration/legend#legenditem#legenditemvisual) can be overridden to render custom text, images, and shapes.
