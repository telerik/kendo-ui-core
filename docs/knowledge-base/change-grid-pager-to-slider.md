...
page_title: Change Pager to Slider - Kendo UI for jQuery Data Grid
description: "Learn how to change the default paging to a slider in a Kendo UI Grid for jQuery."
