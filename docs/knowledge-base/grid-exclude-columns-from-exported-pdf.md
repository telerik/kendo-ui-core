...
description: An example on how to exclude certain columns from the exported Pdf file in a Kendo UI Grid.
type: how-to
...
A possible solution is to hide the columns using the [hideColumn method](https://docs.telerik.com/kendo-ui/api/javascript/ui/grid/methods/hidecolumn) within the [pdfExport event](https://docs.telerik.com/kendo-ui/api/javascript/ui/grid/events/pdfexport) handler and then when the export is done display the hidden column via the [showColumn method](https://docs.telerik.com/kendo-ui/api/javascript/ui/grid/methods/showcolumn).
