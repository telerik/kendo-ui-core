...
1. When the [`group`](https://docs.telerik.com/kendo-ui/api/ui/grid/events/group) event fires, check for a group by the column which is bound to an object.

1. If such a group exists, use the [`group`](https://docs.telerik.com/kendo-ui/api/data/datasource/methods/group) method of the dataSource to add a group by one of the properties of the object.
