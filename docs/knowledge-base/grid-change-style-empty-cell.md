...
## See Also
* [columns.attributes property - Kendo UI Grid jQuery API](https://docs.telerik.com/kendo-ui/api/ui/grid/configuration/columns#columnsattributes)
