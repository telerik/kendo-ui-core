...
page_title: Prevent Editing for Boolean Records - Kendo UI for jQuery Data Grid
description: "Learn how to prevent editing for records based on Boolean values in the Kendo UI Grid for jQuery."
