...
type: how-to
page_title: Group Only One Column at a Time - Kendo UI for jQuery Data Grid
...
1. Handle the [`dataBinding`](https://docs.telerik.com/kendo-ui/api/ui/grid/events/databinding) event of the Grid.
