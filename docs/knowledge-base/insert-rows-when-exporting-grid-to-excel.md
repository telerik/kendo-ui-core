...
When the [`excelExport`](https://docs.telerik.com/kendo-ui/api/ui/grid/events/excelexport) event is fired, access the configuration object of the Excel workbook and add rows to its sheets in the `e.workbook` property.
