...
type: how-to
page_title: Get the DataItem of the Last Selected Row Only - Kendo UI for jQuery Data Grid
...
1. Get the row data by using the [`dataItem`](https://docs.telerik.com/kendo-ui/api/ui/grid/methods/dataitem) method of the Grid.
