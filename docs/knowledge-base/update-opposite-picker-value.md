---
title: Update the Opposite Picker Value of the Scheduler on Model Change
page_title: Update the Opposite Picker Value of the Scheduler on Model Change
description: "Learn how to update the opposite start or end picker value on model change in the Kendo UI for jQuery Scheduler."
