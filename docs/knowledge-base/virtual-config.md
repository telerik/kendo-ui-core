...
The following example demonstrates how to define the [`virtual`](/api/ui/combobox/configuration/virtual) option of the Kendo UI ComboBox widget by using the `data-*` attribute.
