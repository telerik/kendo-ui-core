...
type: how-to
page_title: Force Scrolling to Selected Element - Kendo UI for jQuery Data Grid
...
1. Handle the [`change`](https://docs.telerik.com/kendo-ui/api/ui/grid/events/change) event.
