...
1. Handle the [`edit`](/api/ui/grid/events/edit) event of the Grid and attach an event handler for the [`close`](/api/ui/window/events/close) event of the Popup window.
