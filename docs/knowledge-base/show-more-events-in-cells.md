...
As of the 2020 R1, you can use the [`views.eventsPerDay`](/api/ui/scheduler/configuration/views#viewseventsperday) option, to set the number of events in the `month` view.
