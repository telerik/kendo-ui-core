...
To use a variable from an external method in the [`footerTemplate`](/api/ui/grid/configuration/columns#columnsfootertemplate) of a Kendo UI Grid, you need to ensure that the variable is accessible in the scope where the Grid is defined. You can then reference this variable directly within the `footerTemplate`.
...
- [Kendo UI Grid footerTemplate Documentation](https://docs.telerik.com/kendo-ui/api/ui/grid/configuration/columns#columnsfootertemplate)
