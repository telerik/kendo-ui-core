...
1. Handle the [`columnHide`](https://docs.telerik.com/kendo-ui/api/ui/grid/events/columnhide) and [`columnShow`](https://docs.telerik.com/kendo-ui/api/ui/grid/events/columnshow) events of the Grid.
