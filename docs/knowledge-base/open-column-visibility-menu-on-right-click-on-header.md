...
description: Learn how to add a custom menu that opens when the user right-clicks the column header of the Kendo UI Grid.
type: how-to
page_title: Implement Custom Menu for Toggling the Visibility of Columns on Right-Clicking the Column Header - Kendo UI for jQuery Data Grid
