...
page_title:  Hide the Vertical Scrollbar - Kendo UI for jQuery Data Grid
description: "Learn how to hide the vertical scrollbar when you do not need it in the Kendo UI Grid for jQuery."
