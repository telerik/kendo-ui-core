...
Note that the [dataSource `type`](/api/data/datasource/configuration/type) differs from the [`type` of the transport actions](/api/data/datasource/configuration/transport#transportread#transportreadtype).
