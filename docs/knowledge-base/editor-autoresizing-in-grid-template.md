---
title: Example of auto-resizing Editor inside Grid's editor template
description: How to render a Kendo auto-resizing Editor in Grid editor template
type: how-to
page_title: Editor in Grid Editor Template | Kendo UI Grid 
...
How to render a Kendo auto-resizing Editor in Grid editor template?

## Solution

1. In the Grid columns editor functon initialize the Editor.
1. In the edit event handler add a custom class to the Editor. 
1. Add styles to the custom class so the Editor to have width and height 100%.
