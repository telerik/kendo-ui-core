...
1. The Kendo UI Gantt's [`editable.confirmation`](/api/ui/gantt/configuration/editable.confirmation) should be set to `false` to prevent the default confirm window from showing.
