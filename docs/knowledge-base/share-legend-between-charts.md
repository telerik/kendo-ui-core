...
description: Learn how to create a shared legend to show and hide series in two or more Kendo UI Charts.
type: how-to
...
Handle the [`legendItemClick`](https://docs.telerik.com/kendo-ui/api/dataviz/ui/chart/events/legenditemclick) event of the first Chart and manually toggle the series visibility in the other Charts.
...
If the order of the series is different across the Charts, you can also [access the series by their names](https://docs.telerik.com/kendo-ui/api/dataviz/ui/chart/methods/findseriesbyname).  
