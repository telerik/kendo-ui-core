...
Set the [`format`](/api/ooxml/workbook/configuration/sheets/rows/cells#sheetsrowscellsformat) option of the cells. For more information on the formats that are supported by Excel, refer to the page on [creating a custom number format](https://support.office.com/en-us/article/Create-a-custom-number-format-78f2a361-936b-4c03-8772-09fab54be7f4).
