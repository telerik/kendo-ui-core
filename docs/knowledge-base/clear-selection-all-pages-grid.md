...
type: how-to
page_title: Clear Persisted Selection - Kendo UI for jQuery Data Grid
...
1. Invoke the [`clearSelection`](https://docs.telerik.com/kendo-ui/api/ui/grid/methods/clearselection) method.
