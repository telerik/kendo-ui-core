...
Alternatively, do not destroy the existing Dialog instance&mdash;[open](/api/ui/dialog/methods/open) it and [set new static content](/api/ui/dialog/methods/content) if needed.
