...
Use the grouping capabilities of the Chart while setting the series [`type`](https://docs.telerik.com/kendo-ui/api/dataviz/ui/chart/configuration/series#seriestype) on the `dataBound` event.
