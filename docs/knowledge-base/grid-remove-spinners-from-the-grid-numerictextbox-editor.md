...
Set a custom editor for the numeric columns by using the [`column.editor`](https://docs.telerik.com/kendo-ui/api/ui/grid/configuration/columns#columnseditor) property of the Grid.
