...
1. Use the [`series.color`](https://docs.telerik.com/kendo-ui/api/dataviz/ui/chart/configuration/series#seriescolor) configuration to set the external gradient.
