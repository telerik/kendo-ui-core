...
1. Handle the [`edit`](https://docs.telerik.com/kendo-ui/api/ui/grid/events/edit) event of the Grid and add a custom CSS rule which explicitly specifies the dimensions of the popup wrapper.
