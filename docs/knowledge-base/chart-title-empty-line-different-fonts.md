...
1. Split the [`text`](https://docs.telerik.com/kendo-ui/api/dataviz/ui/chart/configuration/title) into three lines by using line feed characters(`\n`).
1. Handle the [`render`](https://docs.telerik.com/kendo-ui/api/dataviz/ui/chart/events/render) event of the Chart.
