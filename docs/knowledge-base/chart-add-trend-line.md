...
1. Add an additional [`series`](https://docs.telerik.com/kendo-ui/api/dataviz/ui/chart/configuration/series) with the average values to the Chart.
2. Remove the [`markers`](https://docs.telerik.com/kendo-ui/api/dataviz/ui/chart/configuration/series#seriesmarkers) by using the [`visible`](https://docs.telerik.com/kendo-ui/api/dataviz/ui/chart/configuration/series/markers#seriesmarkersvisible) property of the `series` so that the average values stand out as a line instead of a series.
