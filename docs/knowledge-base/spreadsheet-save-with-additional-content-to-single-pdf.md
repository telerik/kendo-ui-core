...
* [API Reference of the Drawing Group](https://docs.telerik.com/kendo-ui/api/drawing/group)
* [API Reference of the Drawing](https://docs.telerik.com/kendo-ui/api/drawing)
