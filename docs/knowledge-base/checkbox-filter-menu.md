...
page_title: Create Checkbox Filter Menu - Kendo UI for jQuery Data Grid
description: "Learn how to create a checkbox filter menu functionality in the component."
