...
Some of the flowchart shapes are available as pre-defined shape [`types`](/api/dataviz/diagram/shape/configuration/type) in the Diagram. Define the rest of the shapes by using a [`Path`](/api/dataviz/diagram/path) object.
