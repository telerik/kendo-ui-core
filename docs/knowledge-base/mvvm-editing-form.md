...
```dojo
    ...
    <script id="tmp" type="text/x-kendo-template">
        <li data-uid="#: uid #"> ID: #: ProductID # Product Name: #: ProductName # <input data-role="button" type="button" value="edit" class="edit-button k-button k-button-sm k-button-rectangle k-rounded-md k-button-solid k-button-solid-base" /></li>
    </script>
    ...
    <div id="editForm">
      ...
      <ul>
        ...
        <li class="buttons">
          ...
          <button class="k-button k-button-md k-button-rectangle k-rounded-md k-button-solid k-button-solid-base btnSave" data-bind="events: { click: sync }">Save</button>
          <button class="k-button k-button-md k-button-rectangle k-rounded-md k-button-solid k-button-solid-base btnCancel" data-bind="events: { click: cancel }">Cancel</button>
        </li>
      </ul>
    </div>
    <script>
