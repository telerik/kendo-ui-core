...
1. Remove the master checkbox by adding an empty [header template](https://docs.telerik.com/kendo-ui/api/ui/grid/configuration/columns.headertemplate) to the column.
