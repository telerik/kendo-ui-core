...
page_title: Editing Records via External Forms - Kendo UI for jQuery Data Grid
description: "Learn how to edit records through an external form in the Kendo UI Grid widget for jQuery."
