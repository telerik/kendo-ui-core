...
If you omit the [`columns`](https://docs.telerik.com/kendo-ui/api/ui/grid/configuration/columns) setting of the Grid, a column is generated for each field in the model.
