...
type: how-to
page_title: Filter All Columns with Single Textbox - Kendo UI for jQuery Data Grid
...
1. Filter the data source by using the [`filter`](https://docs.telerik.com/kendo-ui/api/data/datasource/methods/filter) method.
