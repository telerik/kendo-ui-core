...
For more information on the API settings, refer to the documentation on the [`insert`](https://docs.telerik.com/kendo-ui/api/data/datasource/methods/insert) and [`indexOf`](https://docs.telerik.com/kendo-ui/api/data/datasource/methods/indexof) methods.  
