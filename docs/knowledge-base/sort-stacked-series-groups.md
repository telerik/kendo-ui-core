...
* Collect the stack values in an array. The stackValue can be obtained from the [labels.template](/api/dataviz/ui/chart/configuration/series.labels.template).
