...
page_title:  Create and Use Auto Layout - Kendo UI Data Grid for jQuery
description: "Learn how to create and use auto layout in the Kendo UI Grid for jQuery."
