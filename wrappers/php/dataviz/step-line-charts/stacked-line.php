...
$silver->name('Silver Medals')
       ->data(array(19, 25, 21, 26, 28, 31, 35, null, 60, 31, 34, 32, 24, 40, 38, 29))
       ->color('#b8b8b8');

$bronze = new \Kendo\Dataviz\UI\ChartSeriesItem();
$bronze->name('Bronze Medals')
       ->data(array(17, 17, 16, 28, 34, 30, 25, null, 30, 27, 37, 25, 33, 26, 36, 29))
       ->color('#bb6e36');
...
$chart->title(array('text' => 'Olympic Medals won by USA'))
      ...
      ->tooltip($tooltip)
      ->seriesDefaults(array('type' => 'stepLine', 'missingValues' => 'gap', 'stack' => true));
