...
//>> Properties
    ...
    public function setLabels(\Kendo\Dataviz\UI\ChartXAxisItemLabels $value) {
    ...
    public function setLine(\Kendo\Dataviz\UI\ChartXAxisItemLine $value) {
        $this->setProperty('line', $value);

        return $this;
    }

    public function setMajorGridLines(\Kendo\Dataviz\UI\ChartXAxisItemMajorGridLines $value) {
        $this->setProperty('majorGridLines', $value);

        return $this;
    }

    public function setMajorTicks(\Kendo\Dataviz\UI\ChartXAxisItemMajorTicks $value) {
    ...
    public function setTitle(\Kendo\Dataviz\UI\ChartXAxisItemTitle $value) {
