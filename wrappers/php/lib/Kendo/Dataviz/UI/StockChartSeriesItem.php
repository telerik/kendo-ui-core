...
//>> Properties
    ...
    public function setHighlight(\Kendo\Dataviz\UI\StockChartSeriesItemHighlight $value) {
    ...
    public function setBorder(\Kendo\Dataviz\UI\StockChartSeriesItemBorder $value) {
    ...
    public function setLabels(\Kendo\Dataviz\UI\StockChartSeriesItemLabels $value) {
    ...
    public function setLine(\Kendo\Dataviz\UI\StockChartSeriesItemLine $value) {
        $this->setProperty('line', $value);
    ...
    public function setMarkers(\Kendo\Dataviz\UI\StockChartSeriesItemMarkers $value) {
    ...
    public function setOverlay(\Kendo\Dataviz\UI\StockChartSeriesItemOverlay $value) {
    ...
    public function setTooltip(\Kendo\Dataviz\UI\StockChartSeriesItemTooltip $value) {
