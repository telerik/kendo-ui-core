...
public class ElementTest {
    ...
    @Test
    public void attrOutputsAttribute() throws IOException {
        element.attr("title", "foo");

        assertEquals("<div title=\"foo\"></div>", element.outerHtml());
    }

    @Test
    public void attrReturnsSelf() {
        assertEquals(element, element.attr("foo", "bar"));
    }
}
