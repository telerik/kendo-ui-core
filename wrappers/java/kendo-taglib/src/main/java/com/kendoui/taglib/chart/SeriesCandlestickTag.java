...
public class SeriesCandlestickTag extends  BaseTag  /* interfaces *//* interfaces */ {
...
//>> Attributes
    ...
    public static String tagName() {
        return "chart-series-candlestick";
    }

    public void setBorder(CandlestickBorderTag value) {
        setProperty("border", value);
    }

    public void setOverlay(CandlestickOverlayTag value) {
        setProperty("overlay", value);
    }

    public void setTooltip(CandlestickTooltipTag value) {
