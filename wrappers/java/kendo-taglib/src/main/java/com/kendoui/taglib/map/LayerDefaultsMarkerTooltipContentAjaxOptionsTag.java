...
public class LayerDefaultsMarkerTooltipContentAjaxOptionsTag extends  BaseTag  /* interfaces *//* interfaces */ {
    
    @Override
    public int doEndTag() throws JspException {
//>> doEndTag

        LayerDefaultsMarkerTooltipContentTag parent = (LayerDefaultsMarkerTooltipContentTag)findParentWithClass(LayerDefaultsMarkerTooltipContentTag.class);
