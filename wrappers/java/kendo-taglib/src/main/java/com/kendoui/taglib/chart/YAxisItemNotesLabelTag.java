...
public class YAxisItemNotesLabelTag extends  BaseTag  /* interfaces */ /* interfaces */ {
...
//>> Attributes
    ...
    public static String tagName() {
        return "chart-yAxisItem-notes-label";
    }

    public void setBorder(com.kendoui.taglib.chart.YAxisItemNotesLabelBorderTag value) {
        setProperty("border", value);
    }

    public void setTemplate(YAxisItemNotesLabelTemplateFunctionTag value) {
