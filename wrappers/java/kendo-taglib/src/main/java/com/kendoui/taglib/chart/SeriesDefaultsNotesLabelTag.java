...
public class SeriesDefaultsNotesLabelTag extends  BaseTag  /* interfaces */ /* interfaces */ {
...
//>> Attributes
    ...
    public static String tagName() {
        return "chart-seriesDefaults-notes-label";
    }

    public void setBorder(com.kendoui.taglib.chart.SeriesDefaultsNotesLabelBorderTag value) {
        setProperty("border", value);
    }

    public void setTemplate(SeriesDefaultsNotesLabelTemplateFunctionTag value) {
