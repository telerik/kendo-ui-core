...
public class MarkerTooltipContentAjaxOptionsTag extends  BaseTag  /* interfaces *//* interfaces */ {
    
    @Override
    public int doEndTag() throws JspException {
//>> doEndTag

        MarkerTooltipContentTag parent = (MarkerTooltipContentTag)findParentWithClass(MarkerTooltipContentTag.class);
