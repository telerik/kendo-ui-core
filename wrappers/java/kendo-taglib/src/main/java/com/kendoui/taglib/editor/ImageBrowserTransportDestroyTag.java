...
public class ImageBrowserTransportDestroyTag extends  BaseTag  /* interfaces */ /* interfaces */ {
...
//>> Attributes
    ...
    public static String tagName() {
        return "editor-imageBrowser-transport-destroy";
    }

    public void setData(ImageBrowserTransportDestroyDataFunctionTag value) {
        setEvent("data", value.getBody());
    }

    public void setUrl(ImageBrowserTransportDestroyUrlFunctionTag value) {
