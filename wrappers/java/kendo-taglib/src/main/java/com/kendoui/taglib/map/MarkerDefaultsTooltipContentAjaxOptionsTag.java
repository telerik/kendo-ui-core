...
public class MarkerDefaultsTooltipContentAjaxOptionsTag extends  BaseTag  /* interfaces *//* interfaces */ {
    
    @Override
    public int doEndTag() throws JspException {
//>> doEndTag

        MarkerDefaultsTooltipContentTag parent = (MarkerDefaultsTooltipContentTag)findParentWithClass(MarkerDefaultsTooltipContentTag.class);
