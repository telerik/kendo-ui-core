...
public class YAxisItemNotesDataItemLabelTag extends  BaseTag  /* interfaces */ /* interfaces */ {
...
//>> Attributes
    ...
    public static String tagName() {
        return "chart-yAxisItem-notes-dataItem-label";
    }

    public void setBorder(com.kendoui.taglib.chart.YAxisItemNotesDataItemLabelBorderTag value) {
        setProperty("border", value);
    }

    public void setTemplate(YAxisItemNotesDataItemLabelTemplateFunctionTag value) {
