...
public class LayerTooltipContentAjaxOptionsTag extends  BaseTag  /* interfaces *//* interfaces */ {
    
    @Override
    public int doEndTag() throws JspException {
//>> doEndTag

        LayerTooltipContentTag parent = (LayerTooltipContentTag)findParentWithClass(LayerTooltipContentTag.class);
