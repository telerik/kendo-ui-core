...
public class FileBrowserTransportDestroyTag extends  BaseTag  /* interfaces */ /* interfaces */ {
...
//>> Attributes
    ...
    public static String tagName() {
        return "editor-fileBrowser-transport-destroy";
    }

    public void setData(FileBrowserTransportDestroyDataFunctionTag value) {
        setEvent("data", value.getBody());
    }

    public void setUrl(FileBrowserTransportDestroyUrlFunctionTag value) {
