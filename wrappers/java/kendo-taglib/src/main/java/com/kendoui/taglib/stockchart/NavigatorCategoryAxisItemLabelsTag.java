...
public class NavigatorCategoryAxisItemLabelsTag extends  BaseTag  /* interfaces */ /* interfaces */ {
...
//>> Attributes
    ...
    public static String tagName() {
        return "stockChart-navigator-categoryAxisItem-labels";
    }

    public void setBorder(com.kendoui.taglib.stockchart.NavigatorCategoryAxisItemLabelsBorderTag value) {
        setProperty("border", value);
    }

    public void setDateFormats(com.kendoui.taglib.stockchart.NavigatorCategoryAxisItemLabelsDateFormatsTag value) {
        setProperty("dateFormats", value);
    }

    public void setMargin(com.kendoui.taglib.stockchart.NavigatorCategoryAxisItemLabelsMarginTag value) {
        setProperty("margin", value);
    }

    public void setPadding(com.kendoui.taglib.stockchart.NavigatorCategoryAxisItemLabelsPaddingTag value) {
        setProperty("padding", value);
    }

    public void setTemplate(NavigatorCategoryAxisItemLabelsTemplateFunctionTag value) {
