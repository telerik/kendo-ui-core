...
public class ItemButtonTag extends  BaseTag  /* interfaces */ /* interfaces */ {
    
    @Override
    public int doEndTag() throws JspException {
//>> doEndTag

        ItemButtonsTag parent = (ItemButtonsTag)findParentWithClass(ItemButtonsTag.class);
...
//>> Attributes
    ...
    public static String tagName() {
        return "toolBar-item-button";
    }

    public void setClick(ItemButtonClickFunctionTag value) {
        setEvent("click", value.getBody());
    }

    public void setToggle(ItemButtonToggleFunctionTag value) {
