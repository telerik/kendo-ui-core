...
public class FileBrowserTransportCreateTag extends  BaseTag  /* interfaces */ /* interfaces */ {
...
//>> Attributes
    ...
    public static String tagName() {
        return "editor-fileBrowser-transport-create";
    }

    public void setData(FileBrowserTransportCreateDataFunctionTag value) {
        setEvent("data", value.getBody());
    }

    public void setUrl(FileBrowserTransportCreateUrlFunctionTag value) {
