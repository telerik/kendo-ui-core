...
//>> Attributes
    ...
    public static String tagName() {
        return "chart-categoryAxisItem-crosshair-tooltip";
    }

    public void setBorder(com.kendoui.taglib.chart.CategoryAxisItemCrosshairTooltipBorderTag value) {
        setProperty("border", value);
    }

    public void setPadding(com.kendoui.taglib.chart.CategoryAxisItemCrosshairTooltipPaddingTag value) {
