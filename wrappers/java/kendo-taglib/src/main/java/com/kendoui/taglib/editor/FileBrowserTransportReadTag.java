...
public class FileBrowserTransportReadTag extends  BaseTag  /* interfaces */ /* interfaces */ {
...
//>> Attributes
    ...
    public static String tagName() {
        return "editor-fileBrowser-transport-read";
    }

    public void setData(FileBrowserTransportReadDataFunctionTag value) {
        setEvent("data", value.getBody());
    }

    public void setUrl(FileBrowserTransportReadUrlFunctionTag value) {
