...
public class NavigatorCategoryAxisItemNotesDataItemLabelTag extends  BaseTag  /* interfaces */ /* interfaces */ {
...
//>> Attributes
    ...
    public static String tagName() {
        return "stockChart-navigator-categoryAxisItem-notes-dataItem-label";
    }

    public void setBorder(com.kendoui.taglib.stockchart.NavigatorCategoryAxisItemNotesDataItemLabelBorderTag value) {
        setProperty("border", value);
    }

    public void setTemplate(NavigatorCategoryAxisItemNotesDataItemLabelTemplateFunctionTag value) {
