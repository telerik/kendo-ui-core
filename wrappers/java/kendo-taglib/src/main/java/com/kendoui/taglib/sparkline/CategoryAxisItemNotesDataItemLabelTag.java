...
//>> Attributes
    ...
    public static String tagName() {
        return "sparkline-categoryAxisItem-notes-dataItem-label";
    }

    public void setBorder(com.kendoui.taglib.sparkline.CategoryAxisItemNotesDataItemLabelBorderTag value) {
