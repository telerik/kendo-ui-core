...
//>> Attributes
    ...
    public void setClose(com.kendoui.taglib.autocomplete.AnimationCloseTag value) {
        setProperty("close", value);
    }

    public void setOpen(com.kendoui.taglib.autocomplete.AnimationOpenTag value) {
