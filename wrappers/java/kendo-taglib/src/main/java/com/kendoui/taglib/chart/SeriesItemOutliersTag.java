...
public class SeriesItemOutliersTag extends  BaseTag  /* interfaces */ /* interfaces */ {
...
//>> Attributes
    ...
    public static String tagName() {
        return "chart-seriesItem-outliers";
    }

    public void setBorder(com.kendoui.taglib.chart.SeriesItemOutliersBorderTag value) {
        setProperty("border", value);
    }

    public void setBackground(SeriesItemOutliersBackgroundFunctionTag value) {
        setEvent("background", value.getBody());
    }

    public void setSize(SeriesItemOutliersSizeFunctionTag value) {
        setEvent("size", value.getBody());
    }

    public void setType(SeriesItemOutliersTypeFunctionTag value) {
