...
public class SeriesScatterLineTag extends  BaseTag  /* interfaces *//* interfaces */ {
...
//>> Attributes
    ...
    public static String tagName() {
        return "chart-series-scatterLine";
    }

    public void setLabels(ScatterLineLabelsTag value) {
        setProperty("labels", value);
    }

    public void setMarkers(ScatterLineMarkersTag value) {
        setProperty("markers", value);
    }

    public void setTooltip(ScatterLineTooltipTag value) {
