	...
	<div id="example" class="k-content">
         <div class="chart-wrapper">
         	 <kendo:chart name="chart">
         	 	 ...
         	 	 <kendo:chart-series>
         	 	 	<kendo:chart-seriesItem type="line" stack="true" data="<%= new double[] { 15.7, 16.7, 20, 23.5, 26.6 } %>" name="World"></kendo:chart-seriesItem>
         	 	 	<kendo:chart-seriesItem type="line" stack="true" data="<%= new double[] { 67.96, 68.93, 75, 74, 78 } %>" name="United States"></kendo:chart-seriesItem>
         	 	 </kendo:chart-series>
