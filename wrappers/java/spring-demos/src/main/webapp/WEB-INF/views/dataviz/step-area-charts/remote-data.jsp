...
<demo:header />
     <div class="chart-wrapper">
         <kendo:chart name="chart">
             ...
             <kendo:chart-series>
                <kendo:chart-seriesItem type="stepArea" field="nuclear" name="Nuclear" />
                <kendo:chart-seriesItem type="stepArea" field="hydro" name="Hydro" />
                <kendo:chart-seriesItem type="stepArea" field="wind" name="Wind" />
             </kendo:chart-series>
