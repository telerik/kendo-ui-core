...
<c:url value="/treelist/editing/create" var="createUrl" />
<c:url value="/treelist/editing/read" var="readUrl" />
<c:url value="/treelist/editing/update" var="updateUrl" />
<c:url value="/treelist/editing/destroy" var="destroyUrl" />
