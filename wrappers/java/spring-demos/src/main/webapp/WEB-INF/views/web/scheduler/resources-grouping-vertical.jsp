...
<c:url value="/web/scheduler/resources-grouping-vertical/read" var="readUrl" />
<c:url value="/web/scheduler/resources-grouping-vertical/create" var="createUrl" />
<c:url value="/web/scheduler/resources-grouping-vertical/update" var="updateUrl" />
<c:url value="/web/scheduler/resources-grouping-vertical/destroy" var="destroyUrl" />
