...
<demo:header />
     <div class="chart-wrapper">
         ...
         <kendo:chart name="chart">
             ...
             <kendo:chart-series>
             	<kendo:chart-seriesItem type="stepArea" data="<%= new double[] { 3.907, 7.943, 7.848, 9.284, 9.263, 9.801, 3.890, 8.238, 9.552, 6.855 } %>" name="India" />
                <kendo:chart-seriesItem type="stepArea" data="<%= new double[] { 1.988, 2.733, 3.994, 3.464, 4.001, 3.939, 1.333, -2.245, 4.339, 2.727 } %>" name="World" />
                <kendo:chart-seriesItem type="stepArea" data="<%= new double[] { -0.253, 0.362, -3.519, 1.799, 2.252, 3.343, 0.843, 2.877, -5.416, 5.590 } %>" name="Haiti" />
             </kendo:chart-series>
