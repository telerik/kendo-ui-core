         ...
         <div class="chart-wrapper">
         	 <kendo:chart name="chart">
         	 	 ...
         	 	 <kendo:chart-series>
         	 	 	...
         	 	 	<kendo:chart-seriesItem type="line" color="#DE7E42" data="<%= new int[] { 30, 38, 40, 32, 42 } %>" name="MPG" axis="mpg"></kendo:chart-seriesItem>
         	 	 	<kendo:chart-seriesItem type="line" color="#057589" data="<%= new double[] { 7.8, 6.2, 5.9, 7.4, 5.6 } %>" name="l/100 km" axis="l100km"></kendo:chart-seriesItem>
         	 	 </kendo:chart-series>
