...
<demo:header />
     <div class="chart-wrapper">
         <kendo:chart name="chart">
             ...
             <kendo:chart-series>
                <kendo:chart-seriesItem type="area" field="nuclear" name="Nuclear" />
                <kendo:chart-seriesItem type="area" field="hydro" name="Hydro" />
                <kendo:chart-seriesItem type="area" field="wind" name="Wind" />
             </kendo:chart-series>
