     ...
     <div class="chart-wrapper">
         ...
         <kendo:chart name="chart">
             ...
             <kendo:chart-series>
                ...
                <kendo:chart-seriesItem type="stepArea" color="#642381" data="<%= new int[] { 30, 38, 40, 32, 42 } %>" name="mpg" axis="mpg" />
                <kendo:chart-seriesItem type="stepArea" color="#e5388a" data="<%= new double[] { 7.8, 6.2, 5.9, 7.4, 5.6 } %>" name="l/100 km" axis="l100km" />
             </kendo:chart-series>
