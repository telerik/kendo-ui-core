...
<demo:header />
     <div class="chart-wrapper">
         <kendo:chart name="chart">
             ...
             <kendo:chart-series>
                <kendo:chart-seriesItem type="stepLine" field="nuclear" name="Nuclear" />
                <kendo:chart-seriesItem type="stepLine" field="hydro" name="Hydro" />
                <kendo:chart-seriesItem type="stepLine" field="wind" name="Wind" />
             </kendo:chart-series>
