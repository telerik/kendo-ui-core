...
public class EditingCustomValidationController {
    ...
    @RequestMapping(value = "/editing-custom-validation/update", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/editing-custom-validation/create", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/editing-custom-validation/destroy", method = RequestMethod.POST)
