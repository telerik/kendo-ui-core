...
public class ResourcesGroupingHorizontalController {
    ...
    @RequestMapping(value = "/resources-grouping-horizontal/create", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/resources-grouping-horizontal/update", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/resources-grouping-horizontal/destroy", method = RequestMethod.POST)
