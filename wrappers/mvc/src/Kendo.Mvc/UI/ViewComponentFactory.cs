namespace Kendo.Mvc.UI
{
    ...
    public class ViewComponentFactory : IHideObjectMembers
    {
        ...
        {
            return new NumericTextBoxBuilder<double>(new NumericTextBox<double>(ViewContext, ViewData));
        }
        ...
        {
            return new NumericTextBoxBuilder<T>(new NumericTextBox<T>(ViewContext, ViewData));
        }
