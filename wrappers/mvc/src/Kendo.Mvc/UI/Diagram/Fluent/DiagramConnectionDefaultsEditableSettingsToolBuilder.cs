namespace Kendo.Mvc.UI.Fluent
{
    ...
    /// </summary>
    public class DiagramConnectionDefaultsEditableSettingsToolBuilder: IHideObjectMembers
    {
        ...
        public DiagramConnectionDefaultsEditableSettingsToolBuilder Name(string value)
        {
