namespace Kendo.Mvc.UI.Fluent
{
    ...
    /// </summary>
    public class DiagramEditableSettingsToolFactory : IHideObjectMembers
    {
        ...
        /// </summary>
        public virtual DiagramEditableSettingsToolBuilder Custom()
        {
            var item = new DiagramEditableSettingsTool();

            container.Add(item);

            return new DiagramEditableSettingsToolBuilder(item);
        }

        /// <summary>
        /// Adds an item for the edit action.
        /// </summary>
        public virtual DiagramEditableSettingsToolBuilder Edit()
        {
        ...
        /// </summary>
        public virtual DiagramEditableSettingsToolBuilder CreateShape()
        {
        ...
        /// </summary>
        public virtual DiagramEditableSettingsToolBuilder CreateConnection()
        {
        ...
        /// </summary>
        public virtual DiagramEditableSettingsToolBuilder Undo()
        {
        ...
        /// </summary>
        public virtual DiagramEditableSettingsToolBuilder Redo()
        {
        ...
        /// </summary>
        public virtual DiagramEditableSettingsToolBuilder RotateClockwise()
        {
        ...
        /// </summary>
        public virtual DiagramEditableSettingsToolBuilder RotateAnticlockwise()
        {
