namespace Kendo.Mvc.UI
{
    ...
    public class ChartStepAreaSeries<TModel, TValue, TCategory> : ChartBoundSeries<TModel, TValue, TCategory>, IChartStepAreaSeries where TModel : class
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChartStepAreaSeries{TModel, TValue}" /> class.
        /// </summary>
        ...
        public ChartStepAreaSeries(Expression<Func<TModel, TValue>> expression, Expression<Func<TModel, TCategory>> categoryExpression, Expression<Func<TModel, string>> noteTextExpression)
        ...
        public ChartStepAreaSeries(IEnumerable data)
            : base(data)
        {
            Initialize();
        }
        ...
        /// </summary>
        public ChartStepAreaMissingValues? MissingValues
        {
            get;
            set;
        }
        ...
        {
            return new ChartStepAreaSeriesSerializer(this);
        }
    ...
    public class ChartStepAreaSeries<TModel, TValue> : ChartStepAreaSeries<TModel, TValue, string> where TModel : class
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChartStepAreaSeries{TModel, TValue}" /> class.
        /// </summary>
        /// <param name="expression">The expression used to extract the point value from the chart model.</param>
        public ChartStepAreaSeries(Expression<Func<TModel, TValue>> expression)
