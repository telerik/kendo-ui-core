namespace Kendo.Mvc.UI
{
    ...
    internal class ChartStepAreaSeriesSerializer : ChartSeriesSerializerBase
    {
        protected readonly IChartStepAreaSeries series;

        public ChartStepAreaSeriesSerializer(IChartStepAreaSeries series)
            : base(series)
        {
            this.series = series;
        }
        ...
        public override IDictionary<string, object> Serialize()
        {
            ...
            FluentDictionary.For(result)
                .Add("type", series.Orientation == ChartSeriesOrientation.Horizontal ? "stepArea" : "verticalStepArea")
