namespace Kendo.Mvc.UI
{
    ...
    internal class ChartStepLineSeriesSerializer : ChartSeriesSerializerBase
    {
        protected readonly IChartStepLineSeries series;

        public ChartStepLineSeriesSerializer(IChartStepLineSeries series)
            : base(series)
        {
            this.series = series;
        }
        ...
        public override IDictionary<string, object> Serialize()
        {
            ...
            FluentDictionary.For(result)
                .Add("type", series.Orientation == ChartSeriesOrientation.Horizontal ? "stepLine" : "verticalStepLine")
