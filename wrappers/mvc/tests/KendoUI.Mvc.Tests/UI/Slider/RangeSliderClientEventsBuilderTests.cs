namespace Telerik.Web.Mvc.UI.Tests
{
    ...
    public class RangeSliderClientEventsBuilderTests
    {
        private RangeSliderClientEventsBuilder builder;
        private SliderBaseClientEvents clientEvents;

        public RangeSliderClientEventsBuilderTests()
        {
            clientEvents = new SliderBaseClientEvents();
            builder = new RangeSliderClientEventsBuilder(clientEvents);
        }
        ...
        public void OnChange_method_with_Action_param_should_return_builder()
        {
            ...
            Assert.IsType(typeof(RangeSliderClientEventsBuilder), returned);
        }
