namespace Kendo.Mvc.UI.Tests
{
    ...
    {
        private DropDownBaseClientEventsBuilder builder;
        ...
        public DropDownBaseClientEventsBuilderTests()
        {
            ...
            builder = new DropDownBaseClientEventsBuilder(clientEvents);
        }
        ...
        public void Change_Func_should_return_builder()
        {
            ...
            Assert.IsType(typeof(DropDownBaseClientEventsBuilder), returned);
        }
