namespace KendoUI.Mvc.UI.UnitTest
{
    ...
    public class CurrencyInputRenderingTests
    {
        private readonly CurrencyInput input;
        ...
        public CurrencyInputRenderingTests()
        {
            ...
            input = InputTestHelper.CreateCurrencyInput(tagBuilder.Object);
            input.Name = "DecimalInput";
        }

        [Fact]
        public void Render_should_output_DatePicker_start()
        {
            tagBuilder.Setup(t => t.Build("t-currencyinput")).Returns(rootTag.Object).Verifiable();
        ...
        {
            tagBuilder.Setup(t => t.Build("t-currencyinput")).Returns(rootTag.Object);
