namespace Kendo.Mvc.UI.Tests
{
    ...
    public static class TimezoneEditorTestHelper
    {
        ...
        public static TimezoneEditor CreateTimezoneEditor()
        {
            ...
            TimezoneEditor timezoneEditor = new TimezoneEditor(viewContext, null, new ViewDataDictionary());
