namespace Kendo.Mvc.UI.Tests.Chart
{
    ...
    public class ChartSerializationTests
    {
        ...
        {
            chart.Events["dataBound"] = new ClientEvent() { HandlerName = "dataBoundHandler" };
            chart.WriteInitializationScript(textWriter.Object);
        ...
        {
            chart.Events["seriesClick"] = new ClientEvent() { HandlerName = "seriesClickHandler" };
            chart.WriteInitializationScript(textWriter.Object);
        ...
        public void DataBinding_should_be_serialized_when_using_Server_binding()
        {
            ...
            output.ShouldContain("{dataSource:{data:[{\"RepName\":null,\"DateString\":null,\"Date\":\"\\/Date(-62135596800000)\\/\",\"TotalSales\":0,\"RepSales\":0,\"Explode\":false,\"Color\":null}]}}");
        }
