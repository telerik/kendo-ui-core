namespace Kendo.Mvc.UI.Tests.Chart
{
    ...
    public class ChartOHLCSeriesHighlightBuilderTests
    {
        protected ChartSeriesHighlight highlight;
        protected ChartOHLCSeriesHighlightBuilder builder;

        public ChartOHLCSeriesHighlightBuilderTests()
        {
            highlight = new ChartSeriesHighlight();
            builder = new ChartOHLCSeriesHighlightBuilder(highlight);
        }
