namespace Kendo.Mvc.UI.Fluent.Tests
{
    ...
    public class PivotGridCustomDataSourceSchemaBuilderTests
    {
        private readonly PivotGridDataSourceSchema schema;
        private readonly PivotGridCustomDataSourceSchemaBuilder builder;

        public PivotGridCustomDataSourceSchemaBuilderTests()
        {
            schema = new PivotGridDataSourceSchema();
            builder = new PivotGridCustomDataSourceSchemaBuilder(schema);
        }
