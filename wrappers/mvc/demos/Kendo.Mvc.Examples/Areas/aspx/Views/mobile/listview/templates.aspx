...
<style scoped>
    ...
    #listview-templates .head
    {
	    ...
	    width: 100%;
	    height: 100px;
	    background: url(<%=Url.Content("~/content/mobile/listview/food.jpg")%>) no-repeat center top;
    ...
    #listview-templates .km-group-title h2
    {
	    ...
	    font-weight: normal;
	    font-size: 1.4em;
	    background-image: -moz-linear-gradient(center top , rgba(255, 255, 255, 0.5), rgba(255, 255, 255, 0.45) 6%, rgba(255, 255, 255, 0.2) 50%, rgba(255, 255, 255, 0.15) 50%, rgba(100, 100, 100, 0)), url(<%=Url.Content("~/content/shared/images/patterns/pattern4.png")%>);
	    background-image: -webkit-gradient(linear, 50% 0, 50% 100%, color-stop(0, rgba(255, 255, 255, 0.5)), color-stop(0.06, rgba(255, 255, 255, 0.45)), color-stop(0.5, rgba(255, 255, 255, 0.2)), color-stop(0.5, rgba(255, 255, 255, 0.15)), color-stop(1, rgba(100, 100, 100, 0))), url(<%=Url.Content("~/content/shared/images/patterns/pattern4.png")%>);
    }

    #listview-templates .km-listview .km-list
    {
	    border-top-color: #dcbe87;
	    background-image: url(<%=Url.Content("~/content/shared/images/patterns/pattern8.png")%>);
    }
