---
title: Icons
page_title: Icons | Telerik UI Breadcrumb HtmlHelper for ASP.NET Core
...
* [Icons of the Breadcrumb HtmlHelper for ASP.NET Core (Demo)](https://demos.telerik.com/aspnet-core/breadcrumb/icons)