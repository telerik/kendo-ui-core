...
For an example on basic DropDownTree events, refer to the [demo on using the events of the DropDownTree](https://demos.telerik.com/aspnet-core/dropdowntree/events).
...
To reference an existing DropDownTree instance, use the [`jQuery.data()`](https://api.jquery.com/jQuery.data/) configuration option. Once a reference is established, use the [DropDownTree API](https://docs.telerik.com/kendo-ui/api/javascript/ui/dropdowntree) to control its behavior.
