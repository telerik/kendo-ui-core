---
title: Drag-and-Drop
page_title: Editing by Dragging and Dropping | Telerik UI TreeList HtmlHelper for ASP.NET Core
description: "Learn how to enable the drag-and-drop editing of the Telerik UI TreeList HtmlHelper for ASP.NET Core."
