...
page_title: Virtual Scrolling | Telerik UI Grid HtmlHelper for ASP.NET Core
description: "Get started with the Telerik UI Grid HtmlHelper for ASP.NET Core and learn how to enable virtual scrolling as an alternative to paging."
...
For runnable examples, refer to the [demo on virtualization of remote data by the Grid](https://demos.telerik.com/aspnet-core/grid/virtualization-remote-data).
...
* [Virtualization of Remote Data by the Grid HtmlHelper for ASP.NET Core (Demo)](https://demos.telerik.com/aspnet-core/grid/virtualization-remote-data)
