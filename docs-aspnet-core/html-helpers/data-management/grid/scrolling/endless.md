...
page_title: Endless Scrolling | Telerik UI Grid HtmlHelper for ASP.NET Core
description: "Get started with the Telerik UI Grid HtmlHelper for ASP.NET Core supporting endless scrolling mode suitable for displaying large number of items."
...
* [Demo on endless scrolling of remote data by the Grid](https://demos.telerik.com/aspnet-core/grid/endless-scrolling-remote)
...
* [Endless Scrolling of Remote Data by the Grid HtmlHelper for ASP.NET Core (Demo)](https://demos.telerik.com/aspnet-core/grid/endless-scrolling-remote)
