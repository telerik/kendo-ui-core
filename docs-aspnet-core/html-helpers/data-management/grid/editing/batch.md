---
title: Batch
page_title: Batch Editing | Telerik UI Grid HtmlHelper for ASP.NET Core
description: "Enable cell edit mode and batch updates in Telerik UI Grid HtmlHelper for ASP.NET Core."
...
The Telerik UI Grid HtmlHelper for ASP.NET Core enables you to implement cell editing and make and save batch updates.
