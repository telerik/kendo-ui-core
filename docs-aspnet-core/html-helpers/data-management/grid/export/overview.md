---
title: Overview
page_title: Export Overview | Telerik UI Grid HtmlHelper for ASP.NET Core
description: "Get started with the UI for ASP.NET Core Grid by Kendo UI and learn how to configure the export functionality of the widget."
...
By default, the Telerik UI Grid HtmlHelper for ASP.NET Core provides a PDF and Excel export functionality.
