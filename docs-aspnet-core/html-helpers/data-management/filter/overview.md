---
title: Overview
page_title: Filter Overview | Telerik UI for ASP.NET Core HTML Helpers
description: "Learn the basics when working with the Telerik UI Filter HtmlHelper for ASP.NET Core (MVC 6 or ASP.NET Core MVC)."
...
* [Demo page for the Filter](https://demos.telerik.com/aspnet-core/filter/index)
