---
title: Data Binding
page_title: Data Binding | Telerik UI Gantt HtmlHelper for ASP.NET Core
description: "Learn the binding options for the Telerik UI Gantt HtmlHelper for ASP.NET Core (MVC 6 or ASP.NET Core MVC)."
