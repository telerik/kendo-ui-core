---
title: Editing
page_title: Editing | UI for ASP.NET Core TreeList
...
The [TreeList HtmlHelper](https://demos.telerik.com/aspnet-core/treelist) provides build-in editing functionality with three different edit modes: PopUp, InLine and InCell(Batch).
