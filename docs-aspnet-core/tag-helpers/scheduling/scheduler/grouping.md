---
title: Grouping
page_title: Grouping | Kendo UI Scheduler Tag Helper for ASP.NET Core
description: "Group the resources in the Kendo UI Scheduler tag helper for ASP.NET Core (MVC 6 or ASP.NET Core MVC)."
