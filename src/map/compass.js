...
(function ($) {
    ...
    function button(dir) {
       return kendo.format('<button class="k-button k-compass-{0}"><span class="k-icon k-i-arrow-{0}"/></button>', dir);
    }

    var BUTTONS = button("n") + button("e") + button("s") + button("w") + '<button class="k-button k-compass-c"><span/></button>';
