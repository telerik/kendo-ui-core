(function ($, undefined) {
	...
	if (kendo.ui.FileBrowser) {
		...
		$.extend(true, kendo.ui.FileBrowser.prototype.options.messages, {
			...
			"invalidFileType": "انتخاب فایل با پسوند \"{0}\" امکان‌پذیر نیست. پسوندهای پشتیبانی شده: {1}",
			"overwriteFile": "فایل با نام \"{0}\" در فولدر انتخابی وجود دارد/ آیا می‌ خواهید آنرا بازنویسی کنید؟",
